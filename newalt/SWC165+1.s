fof(f602516, plain, $false, inference(avatar_sat_refutation, [], [f624, f629, f1983, f2277, f3729, f4153, f4165, f4317, f4439, f4879, f5336, f6631, f8766, f8771, f8822, f8852, f12786, f14043, f14329, f15568, f34402, f58009, f58044, f69760, f74042, f88056, f109112, f109120, f109623, f109626, f113255, f115198, f117230, f120491, f120605, f129458, f129664, f135555, f136010, f145993, f150987, f153812, f154639, f154642, f154878, f170658, f175394, f175395, f178254, f179017, f179018, f180865, f200469, f200480, f201083, f201862, f201865, f202934, f215465, f226130, f226191, f231576, f231607, f231610, f231618, f231628, f258384, f273855, f285651, f302206, f302229, f333205, f342397, f386897, f398934, f400177, f416028, f442294, f443485, f456689, f490931, f493635, f530798, f531260, f535128, f542848, f567540, f568875, f573006, f599273, f599686])).
fof(f599686, plain, (~ spl65_62 | ~ spl65_1947 | ~ spl65_6872 | ~ spl65_7832 | ~ spl65_7956 | spl65_16416 | ~ spl65_21242), inference(avatar_contradiction_clause, [], [f599685])).
fof(f599685, plain, ($false | (~ spl65_62 | ~ spl65_1947 | ~ spl65_6872 | ~ spl65_7832 | ~ spl65_7956 | spl65_16416 | ~ spl65_21242)), inference(subsumption_resolution, [], [f596509, f588156])).
fof(f588156, plain, (~ memberP(nil, sK61) | (~ spl65_1947 | ~ spl65_6872 | ~ spl65_7832 | ~ spl65_7956 | spl65_16416)), inference(backward_demodulation, [], [f586157, f587997])).
fof(f587997, plain, ((nil = sK13(sK57, sK58)) | (~ spl65_1947 | ~ spl65_6872)), inference(forward_demodulation, [], [f39897, f102275])).
...
fof(f586157, plain, (~ memberP(sK13(sK57, sK58), sK61) | (~ spl65_6872 | ~ spl65_7832 | ~ spl65_7956 | spl65_16416)), inference(backward_demodulation, [], [f580261, f102275])).
fof(f580261, plain, (~ memberP(sK13(sK57, sK64), sK61) | (~ spl65_7832 | ~ spl65_7956 | spl65_16416)), inference(backward_demodulation, [], [f578522, f127704])).
...
fof(f578522, plain, (~ memberP(sK13(sK57, sK64), hd(sK57)) | (~ spl65_7956 | spl65_16416)), inference(backward_demodulation, [], [f355261, f129583])).
...
fof(f596509, plain, (memberP(nil, sK61) | (~ spl65_62 | ~ spl65_21242)), inference(backward_demodulation, [], [f493334, f2261])).
...
fof(f599273, plain, (~ spl65_28 | ~ spl65_62 | ~ spl65_8397 | ~ spl65_8761 | ~ spl65_8775 | spl65_12086), inference(avatar_contradiction_clause, [], [f599272])).
fof(f599272, plain, ($false | (~ spl65_28 | ~ spl65_62 | ~ spl65_8397 | ~ spl65_8761 | ~ spl65_8775 | spl65_12086)), inference(subsumption_resolution, [], [f594591, f269830])).
...
fof(f594591, plain, (frontsegP(nil, sK63) | (~ spl65_28 | ~ spl65_62 | ~ spl65_8397 | ~ spl65_8761 | ~ spl65_8775)), inference(backward_demodulation, [], [f277776, f2261])).
...
fof(f355, plain, (? [X2] : (? [X3] : ((((nil = X2) & (nil = X3)) | sP6(X3, X2)) & ? [X4] : (? [X5] : (? [X6] : (? [X7] : (~ neq(X4, X5) & (app(app(app(X6, cons(X4, nil)), cons(X5, nil)), X7) = sK57) & ssList(X7)) & ssList(X6)) & ssItem(X5)) & ssItem(X4)) & (sK57 = X2) & (sK58 = X3) & ssList(X3)) & ssList(X2)) => (? [X3] : ((((nil = sK59) & (nil = X3)) | sP6(X3, sK59)) & ? [X4] : (? [X5] : (? [X6] : (? [X7] : (~ neq(X4, X5) & (app(app(app(X6, cons(X4, nil)), cons(X5, nil)), X7) = sK57) & ssList(X7)) & ssList(X6)) & ssItem(X5)) & ssItem(X4)) & (sK57 = sK59) & (sK58 = X3) & ssList(X3)) & ssList(sK59))), introduced(choice_axiom, [])).
fof(f356, plain, (? [X3] : ((((nil = sK59) & (nil = X3)) | sP6(X3, sK59)) & ? [X4] : (? [X5] : (? [X6] : (? [X7] : (~ neq(X4, X5) & (app(app(app(X6, cons(X4, nil)), cons(X5, nil)), X7) = sK57) & ssList(X7)) & ssList(X6)) & ssItem(X5)) & ssItem(X4)) & (sK57 = sK59) & (sK58 = X3) & ssList(X3)) => ((((nil = sK59) & (nil = sK60)) | sP6(sK60, sK59)) & ? [X4] : (? [X5] : (? [X6] : (? [X7] : (~ neq(X4, X5) & (app(app(app(X6, cons(X4, nil)), cons(X5, nil)), X7) = sK57) & ssList(X7)) & ssList(X6)) & ssItem(X5)) & ssItem(X4)) & (sK57 = sK59) & (sK58 = sK60) & ssList(sK60))), introduced(choice_axiom, [])).
fof(f357, plain, (? [X4] : (? [X5] : (? [X6] : (? [X7] : (~ neq(X4, X5) & (app(app(app(X6, cons(X4, nil)), cons(X5, nil)), X7) = sK57) & ssList(X7)) & ssList(X6)) & ssItem(X5)) & ssItem(X4)) => (? [X5] : (? [X6] : (? [X7] : (~ neq(sK61, X5) & (sK57 = app(app(app(X6, cons(sK61, nil)), cons(X5, nil)), X7)) & ssList(X7)) & ssList(X6)) & ssItem(X5)) & ssItem(sK61))), introduced(choice_axiom, [])).
fof(f358, plain, (? [X5] : (? [X6] : (? [X7] : (~ neq(sK61, X5) & (sK57 = app(app(app(X6, cons(sK61, nil)), cons(X5, nil)), X7)) & ssList(X7)) & ssList(X6)) & ssItem(X5)) => (? [X6] : (? [X7] : (~ neq(sK61, sK62) & (sK57 = app(app(app(X6, cons(sK61, nil)), cons(sK62, nil)), X7)) & ssList(X7)) & ssList(X6)) & ssItem(sK62))), introduced(choice_axiom, [])).
fof(f359, plain, (? [X6] : (? [X7] : (~ neq(sK61, sK62) & (sK57 = app(app(app(X6, cons(sK61, nil)), cons(sK62, nil)), X7)) & ssList(X7)) & ssList(X6)) => (? [X7] : (~ neq(sK61, sK62) & (sK57 = app(app(app(sK63, cons(sK61, nil)), cons(sK62, nil)), X7)) & ssList(X7)) & ssList(sK63))), introduced(choice_axiom, [])).
fof(f360, plain, (? [X7] : (~ neq(sK61, sK62) & (sK57 = app(app(app(sK63, cons(sK61, nil)), cons(sK62, nil)), X7)) & ssList(X7)) => (~ neq(sK61, sK62) & (sK57 = app(app(app(sK63, cons(sK61, nil)), cons(sK62, nil)), sK64)) & ssList(sK64))), introduced(choice_axiom, [])).
fof(f352, plain, ? [X0] : (? [X1] : (? [X2] : (? [X3] : ((((nil = X2) & (nil = X3)) | sP6(X3, X2)) & ? [X4] : (? [X5] : (? [X6] : (? [X7] : (~ neq(X4, X5) & (app(app(app(X6, cons(X4, nil)), cons(X5, nil)), X7) = X0) & ssList(X7)) & ssList(X6)) & ssItem(X5)) & ssItem(X4)) & (X0 = X2) & (X1 = X3) & ssList(X3)) & ssList(X2)) & ssList(X1)) & ssList(X0)), inference(rectify, [], [f234])).
fof(f234, plain, ? [X0] : (? [X1] : (? [X2] : (? [X3] : ((((nil = X2) & (nil = X3)) | sP6(X3, X2)) & ? [X9] : (? [X10] : (? [X11] : (? [X12] : (~ neq(X9, X10) & (app(app(app(X11, cons(X9, nil)), cons(X10, nil)), X12) = X0) & ssList(X12)) & ssList(X11)) & ssItem(X10)) & ssItem(X9)) & (X0 = X2) & (X1 = X3) & ssList(X3)) & ssList(X2)) & ssList(X1)) & ssList(X0)), inference(definition_folding, [], [f223, e233])).
...
fof(f26, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ssList(app(X0, X1)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax26)).
...
fof(f5, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => (frontsegP(X0, X1) <=> ? [X2] : ((app(X1, X2) = X0) & ssList(X2))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax5)).
...
fof(f40, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => ((frontsegP(X1, X2) & frontsegP(X0, X1)) => frontsegP(X0, X2))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax40)).
...
fof(f573006, plain, (spl65_7956 | ~ spl65_1885 | ~ spl65_6300 | ~ spl65_7957 | ~ spl65_8397 | ~ spl65_8745 | ~ spl65_8769 | ~ spl65_8773 | ~ spl65_8775 | ~ spl65_18649), inference(avatar_split_clause, [], [f573003, f386890, f224455, f224440, f224415, f224171, f200511, f129586, f94590, f34276, f129581])).
...
fof(f573003, plain, ((hd(sK57) = hd(sK13(sK57, sK64))) | (~ spl65_1885 | ~ spl65_6300 | ~ spl65_7957 | ~ spl65_8397 | ~ spl65_8745 | ~ spl65_8769 | ~ spl65_8773 | ~ spl65_8775 | ~ spl65_18649)), inference(backward_demodulation, [], [f129588, f572969])).
fof(f572969, plain, ((sK57 = app(sK13(sK57, sK64), sK57)) | (~ spl65_1885 | ~ spl65_6300 | ~ spl65_8397 | ~ spl65_8745 | ~ spl65_8769 | ~ spl65_8773 | ~ spl65_8775 | ~ spl65_18649)), inference(backward_demodulation, [], [f277583, f386892])).
...
fof(f6, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => (rearsegP(X0, X1) <=> ? [X2] : ((app(X2, X1) = X0) & ssList(X2))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax6)).
...
fof(f568875, plain, (~ spl65_87 | spl65_88 | ~ spl65_1885 | ~ spl65_8397 | ~ spl65_8745), inference(avatar_split_clause, [], [f568874, f224171, f200511, f34276, f2718, f2714])).
...
fof(f568874, plain, ((sK57 = sK64) | ~ rearsegP(sK64, sK57) | (~ spl65_1885 | ~ spl65_8397 | ~ spl65_8745)), inference(subsumption_resolution, [], [f568873, f34277])).
fof(f568873, plain, ((sK57 = sK64) | ~ rearsegP(sK64, sK57) | ~ ssList(sK64) | (~ spl65_8397 | ~ spl65_8745)), inference(subsumption_resolution, [], [f555951, f200512])).
fof(f555951, plain, ((sK57 = sK64) | ~ rearsegP(sK64, sK57) | ~ ssList(sK57) | ~ ssList(sK64) | ~ spl65_8745), inference(resolution, [], [f224173, f497])).
...
fof(f48, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ((rearsegP(X1, X0) & rearsegP(X0, X1)) => (X0 = X1)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax48)).
fof(f567540, plain, (~ spl65_280 | ~ spl65_287 | spl65_7832 | ~ spl65_11734 | ~ spl65_21242), inference(avatar_contradiction_clause, [], [f567539])).
fof(f567539, plain, ($false | (~ spl65_280 | ~ spl65_287 | spl65_7832 | ~ spl65_11734 | ~ spl65_21242)), inference(subsumption_resolution, [], [f567538, f127703])).
fof(f127703, plain, (~ (sK61 = hd(sK57)) | spl65_7832), inference(avatar_component_clause, [], [f127702])).
fof(f567538, plain, ((sK61 = hd(sK57)) | (~ spl65_280 | ~ spl65_287 | ~ spl65_11734 | ~ spl65_21242)), inference(subsumption_resolution, [], [f566962, f258377])).
...
fof(f566962, plain, (~ ssItem(sK61) | (sK61 = hd(sK57)) | (~ spl65_280 | ~ spl65_287 | ~ spl65_21242)), inference(resolution, [], [f170706, f493334])).
...
fof(f38, plain, ! [X0] : (ssItem(X0) => ~ memberP(nil, X0)), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax38)).
...
fof(f531260, plain, (~ spl65_88 | spl65_1947 | ~ spl65_5385), inference(avatar_contradiction_clause, [], [f531259])).
fof(f531259, plain, ($false | (~ spl65_88 | spl65_1947 | ~ spl65_5385)), inference(subsumption_resolution, [], [f531258, f88397])).
fof(f531258, plain, (~ (nil = sK13(sK57, sK57)) | (~ spl65_88 | spl65_1947)), inference(forward_demodulation, [], [f39896, f2720])).
...
fof(f17, plain, ssList(nil), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax17)).
...
fof(f3, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssItem(X1) => (memberP(X0, X1) <=> ? [X2] : (? [X3] : ((app(X2, cons(X1, X3)) = X0) & ssList(X3)) & ssList(X2))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax3)).
...
fof(f20, plain, ! [X0] : (ssList(X0) => (? [X1] : (? [X2] : ((cons(X2, X1) = X0) & ssItem(X2)) & ssList(X1)) | (nil = X0))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax20)).
...
fof(f23, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssItem(X1) => (hd(cons(X1, X0)) = X1))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax23)).
...
fof(f25, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssItem(X1) => (tl(cons(X1, X0)) = X0))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax25)).
...
fof(f46, plain, ! [X0] : (ssList(X0) => (frontsegP(nil, X0) <=> (nil = X0))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax46)).
...
fof(f78, plain, ! [X0] : (ssList(X0) => (~ (nil = X0) => (cons(hd(X0), tl(X0)) = X0))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax78)).
...
fof(f49, plain, ! [X0] : (ssList(X0) => rearsegP(X0, X0)), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax49)).
...
fof(f28, plain, ! [X0] : (ssList(X0) => (app(nil, X0) = X0)), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax28)).
...
fof(f79, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => ((app(X2, X1) = app(X0, X1)) => (X0 = X2))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax79)).
...
fof(f45, plain, ! [X0] : (ssList(X0) => frontsegP(X0, nil)), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax45)).
...
fof(f41, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ((frontsegP(X1, X0) & frontsegP(X0, X1)) => (X0 = X1)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax41)).
...
fof(f43, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => (frontsegP(X0, X1) => frontsegP(app(X0, X2), X1))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax43)).
...
fof(f1, plain, ! [X0] : (ssItem(X0) => ! [X1] : (ssItem(X1) => (neq(X0, X1) <=> ~ (X0 = X1)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax1)).
...
fof(f36, plain, ! [X0] : (ssItem(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => (memberP(app(X1, X2), X0) <=> (memberP(X2, X0) | memberP(X1, X0)))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax36)).
...
fof(f85, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => (~ (nil = X0) => (hd(X0) = hd(app(X0, X1)))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax85)).
...
fof(f83, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ((nil = app(X0, X1)) <=> ((nil = X0) & (nil = X1))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax83)).
...
fof(f84, plain, ! [X0] : (ssList(X0) => (app(X0, nil) = X0)), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax84)).
...
fof(f50, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => (rearsegP(X0, X1) => rearsegP(app(X2, X0), X1))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax50)).
...
fof(f81, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssItem(X1) => (cons(X1, X0) = app(cons(X1, nil), X0)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax81)).
...
fof(f21, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssItem(X1) => ~ (nil = cons(X1, X0)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax21)).
...
fof(f70, plain, ! [X0] : (ssItem(X0) => ! [X1] : (ssList(X1) => (strictorderedP(cons(X0, X1)) <=> ((lt(X0, hd(X1)) & strictorderedP(X1) & ~ (nil = X1)) | (nil = X1))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax70)).
...
fof(f33, plain, ! [X0] : (ssItem(X0) => ! [X1] : (ssItem(X1) => (lt(X0, X1) => ~ lt(X1, X0)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax33)).
...
fof(f42, plain, ! [X0] : (ssList(X0) => frontsegP(X0, X0)), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax42)).
...
fof(f55, plain, ! [X0] : (ssList(X0) => segmentP(X0, X0)), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax55)).
...
fof(f51, plain, ! [X0] : (ssList(X0) => rearsegP(X0, nil)), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax51)).
...
fof(f69, plain, strictorderedP(nil), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax69)).
...
fof(f16, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssItem(X1) => ssList(cons(X1, X0)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax16)).
...
fof(f44, plain, ! [X0] : (ssItem(X0) => ! [X1] : (ssItem(X1) => ! [X2] : (ssList(X2) => ! [X3] : (ssList(X3) => (frontsegP(cons(X0, X2), cons(X1, X3)) <=> (frontsegP(X2, X3) & (X0 = X1))))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax44)).
...
fof(f58, plain, ! [X0] : (ssList(X0) => (segmentP(nil, X0) <=> (nil = X0))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax58)).
...
fof(f56, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => ! [X3] : (ssList(X3) => (segmentP(X0, X1) => segmentP(app(app(X2, X0), X3), X1)))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax56)).
...
fof(f24, plain, ! [X0] : (ssList(X0) => (~ (nil = X0) => ssList(tl(X0)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax24)).
...
fof(f22, plain, ! [X0] : (ssList(X0) => (~ (nil = X0) => ssItem(hd(X0)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax22)).
...
fof(f37, plain, ! [X0] : (ssItem(X0) => ! [X1] : (ssItem(X1) => ! [X2] : (ssList(X2) => (memberP(cons(X1, X2), X0) <=> (memberP(X2, X0) | (X0 = X1)))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC165+1.p', ax37)).
