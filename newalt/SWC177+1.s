fof(f542313, plain, $false, inference(avatar_sat_refutation, [], [f617, f622, f2099, f5819, f6770, f6984, f7319, f7324, f7335, f7345, f7485, f8865, f10808, f22094, f31119, f38779, f38920, f40715, f43109, f52620, f52634, f53941, f56284, f68052, f69041, f70239, f71992, f86271, f162571, f241987, f242015, f243347, f460813, f522548])).
fof(f522548, plain, (~ spl62_55 | ~ spl62_68 | spl62_2013), inference(avatar_contradiction_clause, [], [f522547])).
fof(f522547, plain, ($false | (~ spl62_55 | ~ spl62_68 | spl62_2013)), inference(subsumption_resolution, [], [f522546, f2148])).
...
fof(f522546, plain, (~ (nil = cons(sK58, nil)) | (~ spl62_68 | spl62_2013)), inference(forward_demodulation, [], [f41513, f2365])).
...
fof(f460813, plain, (spl62_1908 | ~ spl62_7188 | spl62_12460), inference(avatar_contradiction_clause, [], [f460812])).
fof(f460812, plain, ($false | (spl62_1908 | ~ spl62_7188 | spl62_12460)), inference(subsumption_resolution, [], [f460811, f169262])).
...
fof(f460811, plain, (~ ssList(sK12(sK53, sK61)) | (spl62_1908 | spl62_12460)), inference(subsumption_resolution, [], [f460810, f38872])).
...
fof(f460810, plain, ((nil = sK12(sK53, sK61)) | ~ ssList(sK12(sK53, sK61)) | spl62_12460), inference(resolution, [], [f243278, f455])).
...
fof(f24, plain, ! [X0] : (ssList(X0) => (~ (nil = X0) => ssList(tl(X0)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax24)).
...
fof(f17, plain, ssList(nil), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax17)).
...
fof(f49, plain, ! [X0] : (ssList(X0) => rearsegP(X0, X0)), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax49)).
...
fof(f348, plain, (? [X5] : (? [X6] : (~ neq(X5, X6) & ? [X7] : (? [X8] : ((app(app(app(X7, cons(X5, nil)), cons(X6, nil)), X8) = sK53) & ssList(X8)) & ssList(X7)) & ssItem(X6)) & ssItem(X5)) => (? [X6] : (~ neq(sK58, X6) & ? [X7] : (? [X8] : ((sK53 = app(app(app(X7, cons(sK58, nil)), cons(X6, nil)), X8)) & ssList(X8)) & ssList(X7)) & ssItem(X6)) & ssItem(sK58))), introduced(choice_axiom, [])).
fof(f349, plain, (? [X6] : (~ neq(sK58, X6) & ? [X7] : (? [X8] : ((sK53 = app(app(app(X7, cons(sK58, nil)), cons(X6, nil)), X8)) & ssList(X8)) & ssList(X7)) & ssItem(X6)) => (~ neq(sK58, sK59) & ? [X7] : (? [X8] : ((sK53 = app(app(app(X7, cons(sK58, nil)), cons(sK59, nil)), X8)) & ssList(X8)) & ssList(X7)) & ssItem(sK59))), introduced(choice_axiom, [])).
fof(f350, plain, (? [X7] : (? [X8] : ((sK53 = app(app(app(X7, cons(sK58, nil)), cons(sK59, nil)), X8)) & ssList(X8)) & ssList(X7)) => (? [X8] : ((sK53 = app(app(app(sK60, cons(sK58, nil)), cons(sK59, nil)), X8)) & ssList(X8)) & ssList(sK60))), introduced(choice_axiom, [])).
fof(f351, plain, (? [X8] : ((sK53 = app(app(app(sK60, cons(sK58, nil)), cons(sK59, nil)), X8)) & ssList(X8)) => ((sK53 = app(app(app(sK60, cons(sK58, nil)), cons(sK59, nil)), sK61)) & ssList(sK61))), introduced(choice_axiom, [])).
fof(f222, plain, ? [X0] : (? [X1] : (? [X2] : (? [X3] : ((((nil = X2) & (nil = X3)) | ? [X4] : (memberP(X3, X4) & (cons(X4, nil) = X2) & ssItem(X4))) & ? [X5] : (? [X6] : (~ neq(X5, X6) & ? [X7] : (? [X8] : ((app(app(app(X7, cons(X5, nil)), cons(X6, nil)), X8) = X0) & ssList(X8)) & ssList(X7)) & ssItem(X6)) & ssItem(X5)) & (X0 = X2) & (X1 = X3) & ssList(X3)) & ssList(X2)) & ssList(X1)) & ssList(X0)), inference(ennf_transformation, [], [f98])).
fof(f98, plain, ~ ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => ! [X3] : (((~ (nil = X2) | ~ (nil = X3)) & ! [X4] : (~ memberP(X3, X4) | ~ (cons(X4, nil) = X2) | ~ ssItem(X4))) | ! [X5] : (ssItem(X5) => ! [X6] : (neq(X5, X6) | ! [X7] : (ssList(X7) => ! [X8] : (ssList(X8) => ~ (app(app(app(X7, cons(X5, nil)), cons(X6, nil)), X8) = X0))) | ~ ssItem(X6))) | ~ (X0 = X2) | ~ (X1 = X3) | ~ ssList(X3))))), inference(rectify, [], [f97])).
fof(f97, plain, ~ ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => ! [X3] : (((~ (nil = X2) | ~ (nil = X3)) & ! [X8] : (~ memberP(X3, X8) | ~ (cons(X8, nil) = X2) | ~ ssItem(X8))) | ! [X4] : (ssItem(X4) => ! [X5] : (neq(X4, X5) | ! [X6] : (ssList(X6) => ! [X7] : (ssList(X7) => ~ (app(app(app(X6, cons(X4, nil)), cons(X5, nil)), X7) = X0))) | ~ ssItem(X5))) | ~ (X0 = X2) | ~ (X1 = X3) | ~ ssList(X3))))), inference(negated_conjecture, [], [f96])).
fof(f96, plain, ~ ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => ! [X3] : (((~ (nil = X2) | ~ (nil = X3)) & ! [X8] : (~ memberP(X3, X8) | ~ (cons(X8, nil) = X2) | ~ ssItem(X8))) | ! [X4] : (ssItem(X4) => ! [X5] : (neq(X4, X5) | ! [X6] : (ssList(X6) => ! [X7] : (ssList(X7) => ~ (app(app(app(X6, cons(X4, nil)), cons(X5, nil)), X7) = X0))) | ~ ssItem(X5))) | ~ (X0 = X2) | ~ (X1 = X3) | ~ ssList(X3))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', co1)).
...
fof(f84, plain, ! [X0] : (ssList(X0) => (app(X0, nil) = X0)), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax84)).
...
fof(f50, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => (rearsegP(X0, X1) => rearsegP(app(X2, X0), X1))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax50)).
...
fof(f1, plain, ! [X0] : (ssItem(X0) => ! [X1] : (ssItem(X1) => (neq(X0, X1) <=> ~ (X0 = X1)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax1)).
...
fof(f86, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => (~ (nil = X0) => (tl(app(X0, X1)) = app(tl(X0), X1))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax86)).
...
fof(f26, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ssList(app(X0, X1)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax26)).
...
fof(f48, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ((rearsegP(X1, X0) & rearsegP(X0, X1)) => (X0 = X1)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax48)).
...
fof(f6, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => (rearsegP(X0, X1) <=> ? [X2] : ((app(X2, X1) = X0) & ssList(X2))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax6)).
...
fof(f58, plain, ! [X0] : (ssList(X0) => (segmentP(nil, X0) <=> (nil = X0))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax58)).
...
fof(f35, plain, ! [X0] : (ssItem(X0) => ! [X1] : (ssItem(X1) => (gt(X0, X1) <=> lt(X1, X0)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax35)).
...
fof(f68, plain, ! [X0] : (ssItem(X0) => strictorderedP(cons(X0, nil))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax68)).
...
fof(f12, plain, ! [X0] : (ssList(X0) => (strictorderedP(X0) <=> ! [X1] : (ssItem(X1) => ! [X2] : (ssItem(X2) => ! [X3] : (ssList(X3) => ! [X4] : (ssList(X4) => ! [X5] : (ssList(X5) => ((app(app(X3, cons(X1, X4)), cons(X2, X5)) = X0) => lt(X1, X2))))))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax12)).
...
fof(f94, plain, ! [X0] : (ssItem(X0) => ! [X1] : (ssItem(X1) => (gt(X0, X1) => ~ gt(X1, X0)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax94)).
...
fof(f54, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ((segmentP(X1, X0) & segmentP(X0, X1)) => (X0 = X1)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax54)).
...
fof(f38, plain, ! [X0] : (ssItem(X0) => ~ memberP(nil, X0)), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax38)).
...
fof(f37, plain, ! [X0] : (ssItem(X0) => ! [X1] : (ssItem(X1) => ! [X2] : (ssList(X2) => (memberP(cons(X1, X2), X0) <=> (memberP(X2, X0) | (X0 = X1)))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax37)).
...
fof(f3, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssItem(X1) => (memberP(X0, X1) <=> ? [X2] : (? [X3] : ((app(X2, cons(X1, X3)) = X0) & ssList(X3)) & ssList(X2))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax3)).
...
fof(f21, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssItem(X1) => ~ (nil = cons(X1, X0)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax21)).
...
fof(f90, plain, ! [X0] : (ssItem(X0) => ~ lt(X0, X0)), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax90)).
...
fof(f28, plain, ! [X0] : (ssList(X0) => (app(nil, X0) = X0)), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax28)).
...
fof(f63, plain, ! [X0] : (ssItem(X0) => strictorderP(cons(X0, nil))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax63)).
...
fof(f10, plain, ! [X0] : (ssList(X0) => (strictorderP(X0) <=> ! [X1] : (ssItem(X1) => ! [X2] : (ssItem(X2) => ! [X3] : (ssList(X3) => ! [X4] : (ssList(X4) => ! [X5] : (ssList(X5) => ((app(app(X3, cons(X1, X4)), cons(X2, X5)) = X0) => (lt(X2, X1) | lt(X1, X2)))))))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax10)).
...
fof(f36, plain, ! [X0] : (ssItem(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => (memberP(app(X1, X2), X0) <=> (memberP(X2, X0) | memberP(X1, X0)))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax36)).
...
fof(f79, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => ((app(X2, X1) = app(X0, X1)) => (X0 = X2))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax79)).
...
fof(f7, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => (segmentP(X0, X1) <=> ? [X2] : (? [X3] : ((app(app(X2, X1), X3) = X0) & ssList(X3)) & ssList(X2))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax7)).
...
fof(f25, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssItem(X1) => (tl(cons(X1, X0)) = X0))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax25)).
...
fof(f16, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssItem(X1) => ssList(cons(X1, X0)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC177+1.p', ax16)).
