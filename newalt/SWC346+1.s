fof(f8986, plain, $false, inference(avatar_sat_refutation, [], [f613, f622, f627, f1616, f1654, f1657, f1660, f6860, f6870, f7639, f8955, f8985])).
fof(f8985, plain, (~ spl61_3 | spl61_257), inference(avatar_contradiction_clause, [], [f8984])).
fof(f8984, plain, ($false | (~ spl61_3 | spl61_257)), inference(subsumption_resolution, [], [f8983, f6945])).
fof(f6945, plain, (sP6(sK58, sK57) | ~ spl61_3), inference(forward_demodulation, [], [f6944, f566])).
fof(f566, plain, (sK58 = sK60), inference(cnf_transformation, [], [f355])).
fof(f355, plain, (((((~ strictorderedP(sK57) | ~ segmentP(sK58, sK57)) & (((nil = sK59) & (nil = sK60)) | sP6(sK60, sK59)) & (sK57 = sK59) & (sK58 = sK60) & ssList(sK60)) & ssList(sK59)) & ssList(sK58)) & ssList(sK57)), inference(skolemisation, [status(esa), new_symbols(skolem, [sK57, sK58, sK59, sK60])], [f233, f354, f353, f352, f351])).
fof(f351, plain, (? [X0] : (? [X1] : (? [X2] : (? [X3] : ((~ strictorderedP(X0) | ~ segmentP(X1, X0)) & (((nil = X2) & (nil = X3)) | sP6(X3, X2)) & (X0 = X2) & (X1 = X3) & ssList(X3)) & ssList(X2)) & ssList(X1)) & ssList(X0)) => (? [X1] : (? [X2] : (? [X3] : ((~ strictorderedP(sK57) | ~ segmentP(X1, sK57)) & (((nil = X2) & (nil = X3)) | sP6(X3, X2)) & (sK57 = X2) & (X1 = X3) & ssList(X3)) & ssList(X2)) & ssList(X1)) & ssList(sK57))), introduced(choice_axiom, [])).
fof(f352, plain, (? [X1] : (? [X2] : (? [X3] : ((~ strictorderedP(sK57) | ~ segmentP(X1, sK57)) & (((nil = X2) & (nil = X3)) | sP6(X3, X2)) & (sK57 = X2) & (X1 = X3) & ssList(X3)) & ssList(X2)) & ssList(X1)) => (? [X2] : (? [X3] : ((~ strictorderedP(sK57) | ~ segmentP(sK58, sK57)) & (((nil = X2) & (nil = X3)) | sP6(X3, X2)) & (sK57 = X2) & (sK58 = X3) & ssList(X3)) & ssList(X2)) & ssList(sK58))), introduced(choice_axiom, [])).
fof(f353, plain, (? [X2] : (? [X3] : ((~ strictorderedP(sK57) | ~ segmentP(sK58, sK57)) & (((nil = X2) & (nil = X3)) | sP6(X3, X2)) & (sK57 = X2) & (sK58 = X3) & ssList(X3)) & ssList(X2)) => (? [X3] : ((~ strictorderedP(sK57) | ~ segmentP(sK58, sK57)) & (((nil = sK59) & (nil = X3)) | sP6(X3, sK59)) & (sK57 = sK59) & (sK58 = X3) & ssList(X3)) & ssList(sK59))), introduced(choice_axiom, [])).
fof(f354, plain, (? [X3] : ((~ strictorderedP(sK57) | ~ segmentP(sK58, sK57)) & (((nil = sK59) & (nil = X3)) | sP6(X3, sK59)) & (sK57 = sK59) & (sK58 = X3) & ssList(X3)) => ((~ strictorderedP(sK57) | ~ segmentP(sK58, sK57)) & (((nil = sK59) & (nil = sK60)) | sP6(sK60, sK59)) & (sK57 = sK59) & (sK58 = sK60) & ssList(sK60))), introduced(choice_axiom, [])).
fof(f233, plain, ? [X0] : (? [X1] : (? [X2] : (? [X3] : ((~ strictorderedP(X0) | ~ segmentP(X1, X0)) & (((nil = X2) & (nil = X3)) | sP6(X3, X2)) & (X0 = X2) & (X1 = X3) & ssList(X3)) & ssList(X2)) & ssList(X1)) & ssList(X0)), inference(definition_folding, [], [f222, e232])).
...
fof(f222, plain, ? [X0] : (? [X1] : (? [X2] : (? [X3] : ((~ strictorderedP(X0) | ~ segmentP(X1, X0)) & (((nil = X2) & (nil = X3)) | ? [X4] : (? [X5] : (? [X6] : (! [X7] : (~ lt(X7, X4) | ~ memberP(X6, X7) | ~ ssItem(X7)) & ! [X8] : (~ lt(X4, X8) | ~ memberP(X5, X8) | ~ ssItem(X8)) & (app(app(X5, X2), X6) = X3) & (cons(X4, nil) = X2) & ssList(X6)) & ssList(X5)) & ssItem(X4))) & (X0 = X2) & (X1 = X3) & ssList(X3)) & ssList(X2)) & ssList(X1)) & ssList(X0)), inference(ennf_transformation, [], [f98])).
fof(f98, plain, ~ ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => ! [X3] : ((strictorderedP(X0) & segmentP(X1, X0)) | ((~ (nil = X2) | ~ (nil = X3)) & ! [X4] : (ssItem(X4) => ! [X5] : (ssList(X5) => ! [X6] : (? [X7] : (lt(X7, X4) & memberP(X6, X7) & ssItem(X7)) | ? [X8] : (lt(X4, X8) & memberP(X5, X8) & ssItem(X8)) | ~ (app(app(X5, X2), X6) = X3) | ~ (cons(X4, nil) = X2) | ~ ssList(X6))))) | ~ (X0 = X2) | ~ (X1 = X3) | ~ ssList(X3))))), inference(rectify, [], [f97])).
fof(f97, plain, ~ ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => ! [X3] : ((strictorderedP(X0) & segmentP(X1, X0)) | ((~ (nil = X2) | ~ (nil = X3)) & ! [X4] : (ssItem(X4) => ! [X5] : (ssList(X5) => ! [X6] : (? [X8] : (lt(X8, X4) & memberP(X6, X8) & ssItem(X8)) | ? [X7] : (lt(X4, X7) & memberP(X5, X7) & ssItem(X7)) | ~ (app(app(X5, X2), X6) = X3) | ~ (cons(X4, nil) = X2) | ~ ssList(X6))))) | ~ (X0 = X2) | ~ (X1 = X3) | ~ ssList(X3))))), inference(negated_conjecture, [], [f96])).
fof(f96, plain, ~ ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => ! [X3] : ((strictorderedP(X0) & segmentP(X1, X0)) | ((~ (nil = X2) | ~ (nil = X3)) & ! [X4] : (ssItem(X4) => ! [X5] : (ssList(X5) => ! [X6] : (? [X8] : (lt(X8, X4) & memberP(X6, X8) & ssItem(X8)) | ? [X7] : (lt(X4, X7) & memberP(X5, X7) & ssItem(X7)) | ~ (app(app(X5, X2), X6) = X3) | ~ (cons(X4, nil) = X2) | ~ ssList(X6))))) | ~ (X0 = X2) | ~ (X1 = X3) | ~ ssList(X3))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC346+1.p', co1)).
fof(f6944, plain, (sP6(sK60, sK57) | ~ spl61_3), inference(forward_demodulation, [], [f617, f567])).
...
fof(f8983, plain, (~ sP6(sK58, sK57) | spl61_257), inference(resolution, [], [f7634, f556])).
...
fof(f7634, plain, (~ ssList(sK55(sK58, sK57)) | spl61_257), inference(avatar_component_clause, [], [f7632])).
fof(f7632, plain, (spl61_257 <=> ssList(sK55(sK58, sK57))), introduced(avatar_definition, [new_symbols(naming, [spl61_257])])).
fof(f8955, plain, (~ spl61_3 | spl61_258), inference(avatar_contradiction_clause, [], [f8954])).
fof(f8954, plain, ($false | (~ spl61_3 | spl61_258)), inference(subsumption_resolution, [], [f8953, f6945])).
fof(f8953, plain, (~ sP6(sK58, sK57) | spl61_258), inference(resolution, [], [f7638, f557])).
fof(f557, plain, ! [X0, X1] : (ssList(sK56(X0, X1)) | ~ sP6(X0, X1)), inference(cnf_transformation, [], [f350])).
fof(f7638, plain, (~ ssList(sK56(sK58, sK57)) | spl61_258), inference(avatar_component_clause, [], [f7636])).
fof(f7636, plain, (spl61_258 <=> ssList(sK56(sK58, sK57))), introduced(avatar_definition, [new_symbols(naming, [spl61_258])])).
fof(f7639, plain, (~ spl61_257 | ~ spl61_258 | spl61_1 | ~ spl61_3), inference(avatar_split_clause, [], [f7630, f615, f606, f7636, f7632])).
fof(f606, plain, (spl61_1 <=> segmentP(sK58, sK57)), introduced(avatar_definition, [new_symbols(naming, [spl61_1])])).
fof(f7630, plain, (~ ssList(sK56(sK58, sK57)) | ~ ssList(sK55(sK58, sK57)) | (spl61_1 | ~ spl61_3)), inference(subsumption_resolution, [], [f7629, f628])).
...
fof(f7629, plain, (~ ssList(sK56(sK58, sK57)) | ~ ssList(sK55(sK58, sK57)) | ~ ssList(sK58) | (spl61_1 | ~ spl61_3)), inference(subsumption_resolution, [], [f7628, f629])).
...
fof(f7628, plain, (~ ssList(sK56(sK58, sK57)) | ~ ssList(sK55(sK58, sK57)) | ~ ssList(sK57) | ~ ssList(sK58) | (spl61_1 | ~ spl61_3)), inference(subsumption_resolution, [], [f7607, f608])).
fof(f608, plain, (~ segmentP(sK58, sK57) | spl61_1), inference(avatar_component_clause, [], [f606])).
fof(f7607, plain, (segmentP(sK58, sK57) | ~ ssList(sK56(sK58, sK57)) | ~ ssList(sK55(sK58, sK57)) | ~ ssList(sK57) | ~ ssList(sK58) | ~ spl61_3), inference(superposition, [], [f576, f7050])).
fof(f7050, plain, ((sK58 = app(app(sK55(sK58, sK57), sK57), sK56(sK58, sK57))) | ~ spl61_3), inference(resolution, [], [f6945, f559])).
...
fof(f7, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => (segmentP(X0, X1) <=> ? [X2] : (? [X3] : ((app(app(X2, X1), X3) = X0) & ssList(X3)) & ssList(X2))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC346+1.p', ax7)).
fof(f6870, plain, (spl61_2 | ~ spl61_23), inference(avatar_contradiction_clause, [], [f6869])).
fof(f6869, plain, ($false | (spl61_2 | ~ spl61_23)), inference(subsumption_resolution, [], [f6868, f518])).
fof(f518, plain, strictorderedP(nil), inference(cnf_transformation, [], [f69])).
fof(f69, plain, strictorderedP(nil), file('/home/ubuntu/library/tptp/Problems/SWC/SWC346+1.p', ax69)).
fof(f6868, plain, (~ strictorderedP(nil) | (spl61_2 | ~ spl61_23)), inference(forward_demodulation, [], [f612, f1151])).
...
fof(f612, plain, (~ strictorderedP(sK57) | spl61_2), inference(avatar_component_clause, [], [f610])).
fof(f610, plain, (spl61_2 <=> strictorderedP(sK57)), introduced(avatar_definition, [new_symbols(naming, [spl61_2])])).
...
fof(f17, plain, ssList(nil), file('/home/ubuntu/library/tptp/Problems/SWC/SWC346+1.p', ax17)).
...
fof(f55, plain, ! [X0] : (ssList(X0) => segmentP(X0, X0)), file('/home/ubuntu/library/tptp/Problems/SWC/SWC346+1.p', ax55)).
...
fof(f1616, plain, (~ spl61_28 | spl61_2 | ~ spl61_3), inference(avatar_split_clause, [], [f1572, f615, f610, f1596])).
fof(f1572, plain, (strictorderedP(sK57) | ~ ssItem(sK54(sK58, sK57)) | ~ spl61_3), inference(superposition, [], [f517, f1300])).
...
fof(f517, plain, ! [X0] : (strictorderedP(cons(X0, nil)) | ~ ssItem(X0)), inference(cnf_transformation, [], [f183])).
fof(f183, plain, ! [X0] : (strictorderedP(cons(X0, nil)) | ~ ssItem(X0)), inference(ennf_transformation, [], [f68])).
fof(f68, plain, ! [X0] : (ssItem(X0) => strictorderedP(cons(X0, nil))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC346+1.p', ax68)).
...
fof(f570, plain, (~ strictorderedP(sK57) | ~ segmentP(sK58, sK57)), inference(cnf_transformation, [], [f355])).