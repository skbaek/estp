fof(f8968, plain, $false, inference(avatar_sat_refutation, [], [f613, f622, f627, f1611, f1654, f1657, f1660, f6860, f6867, f7621, f8937, f8967])).
fof(f8967, plain, (~ spl61_3 | spl61_254), inference(avatar_contradiction_clause, [], [f8966])).
fof(f8966, plain, ($false | (~ spl61_3 | spl61_254)), inference(subsumption_resolution, [], [f8965, f6927])).
fof(f6927, plain, (sP6(sK58, sK57) | ~ spl61_3), inference(forward_demodulation, [], [f6926, f566])).
fof(f566, plain, (sK58 = sK60), inference(cnf_transformation, [], [f355])).
fof(f355, plain, (((((~ equalelemsP(sK57) | ~ segmentP(sK58, sK57)) & (((nil = sK59) & (nil = sK60)) | sP6(sK60, sK59)) & (sK57 = sK59) & (sK58 = sK60) & ssList(sK60)) & ssList(sK59)) & ssList(sK58)) & ssList(sK57)), inference(skolemisation, [status(esa), new_symbols(skolem, [sK57, sK58, sK59, sK60])], [f233, f354, f353, f352, f351])).
fof(f351, plain, (? [X0] : (? [X1] : (? [X2] : (? [X3] : ((~ equalelemsP(X0) | ~ segmentP(X1, X0)) & (((nil = X2) & (nil = X3)) | sP6(X3, X2)) & (X0 = X2) & (X1 = X3) & ssList(X3)) & ssList(X2)) & ssList(X1)) & ssList(X0)) => (? [X1] : (? [X2] : (? [X3] : ((~ equalelemsP(sK57) | ~ segmentP(X1, sK57)) & (((nil = X2) & (nil = X3)) | sP6(X3, X2)) & (sK57 = X2) & (X1 = X3) & ssList(X3)) & ssList(X2)) & ssList(X1)) & ssList(sK57))), introduced(choice_axiom, [])).
fof(f352, plain, (? [X1] : (? [X2] : (? [X3] : ((~ equalelemsP(sK57) | ~ segmentP(X1, sK57)) & (((nil = X2) & (nil = X3)) | sP6(X3, X2)) & (sK57 = X2) & (X1 = X3) & ssList(X3)) & ssList(X2)) & ssList(X1)) => (? [X2] : (? [X3] : ((~ equalelemsP(sK57) | ~ segmentP(sK58, sK57)) & (((nil = X2) & (nil = X3)) | sP6(X3, X2)) & (sK57 = X2) & (sK58 = X3) & ssList(X3)) & ssList(X2)) & ssList(sK58))), introduced(choice_axiom, [])).
fof(f353, plain, (? [X2] : (? [X3] : ((~ equalelemsP(sK57) | ~ segmentP(sK58, sK57)) & (((nil = X2) & (nil = X3)) | sP6(X3, X2)) & (sK57 = X2) & (sK58 = X3) & ssList(X3)) & ssList(X2)) => (? [X3] : ((~ equalelemsP(sK57) | ~ segmentP(sK58, sK57)) & (((nil = sK59) & (nil = X3)) | sP6(X3, sK59)) & (sK57 = sK59) & (sK58 = X3) & ssList(X3)) & ssList(sK59))), introduced(choice_axiom, [])).
fof(f354, plain, (? [X3] : ((~ equalelemsP(sK57) | ~ segmentP(sK58, sK57)) & (((nil = sK59) & (nil = X3)) | sP6(X3, sK59)) & (sK57 = sK59) & (sK58 = X3) & ssList(X3)) => ((~ equalelemsP(sK57) | ~ segmentP(sK58, sK57)) & (((nil = sK59) & (nil = sK60)) | sP6(sK60, sK59)) & (sK57 = sK59) & (sK58 = sK60) & ssList(sK60))), introduced(choice_axiom, [])).
fof(f233, plain, ? [X0] : (? [X1] : (? [X2] : (? [X3] : ((~ equalelemsP(X0) | ~ segmentP(X1, X0)) & (((nil = X2) & (nil = X3)) | sP6(X3, X2)) & (X0 = X2) & (X1 = X3) & ssList(X3)) & ssList(X2)) & ssList(X1)) & ssList(X0)), inference(definition_folding, [], [f222, e232])).
...
fof(f222, plain, ? [X0] : (? [X1] : (? [X2] : (? [X3] : ((~ equalelemsP(X0) | ~ segmentP(X1, X0)) & (((nil = X2) & (nil = X3)) | ? [X4] : (? [X5] : (? [X6] : (! [X7] : (~ lt(X7, X4) | ~ memberP(X6, X7) | ~ ssItem(X7)) & ! [X8] : (~ lt(X4, X8) | ~ memberP(X5, X8) | ~ ssItem(X8)) & (app(app(X5, X2), X6) = X3) & (cons(X4, nil) = X2) & ssList(X6)) & ssList(X5)) & ssItem(X4))) & (X0 = X2) & (X1 = X3) & ssList(X3)) & ssList(X2)) & ssList(X1)) & ssList(X0)), inference(ennf_transformation, [], [f98])).
fof(f98, plain, ~ ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => ! [X3] : ((equalelemsP(X0) & segmentP(X1, X0)) | ((~ (nil = X2) | ~ (nil = X3)) & ! [X4] : (ssItem(X4) => ! [X5] : (ssList(X5) => ! [X6] : (? [X7] : (lt(X7, X4) & memberP(X6, X7) & ssItem(X7)) | ? [X8] : (lt(X4, X8) & memberP(X5, X8) & ssItem(X8)) | ~ (app(app(X5, X2), X6) = X3) | ~ (cons(X4, nil) = X2) | ~ ssList(X6))))) | ~ (X0 = X2) | ~ (X1 = X3) | ~ ssList(X3))))), inference(rectify, [], [f97])).
fof(f97, plain, ~ ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => ! [X3] : ((equalelemsP(X0) & segmentP(X1, X0)) | ((~ (nil = X2) | ~ (nil = X3)) & ! [X4] : (ssItem(X4) => ! [X5] : (ssList(X5) => ! [X6] : (? [X8] : (lt(X8, X4) & memberP(X6, X8) & ssItem(X8)) | ? [X7] : (lt(X4, X7) & memberP(X5, X7) & ssItem(X7)) | ~ (app(app(X5, X2), X6) = X3) | ~ (cons(X4, nil) = X2) | ~ ssList(X6))))) | ~ (X0 = X2) | ~ (X1 = X3) | ~ ssList(X3))))), inference(negated_conjecture, [], [f96])).
fof(f96, plain, ~ ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => ! [X3] : ((equalelemsP(X0) & segmentP(X1, X0)) | ((~ (nil = X2) | ~ (nil = X3)) & ! [X4] : (ssItem(X4) => ! [X5] : (ssList(X5) => ! [X6] : (? [X8] : (lt(X8, X4) & memberP(X6, X8) & ssItem(X8)) | ? [X7] : (lt(X4, X7) & memberP(X5, X7) & ssItem(X7)) | ~ (app(app(X5, X2), X6) = X3) | ~ (cons(X4, nil) = X2) | ~ ssList(X6))))) | ~ (X0 = X2) | ~ (X1 = X3) | ~ ssList(X3))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC330+1.p', co1)).
fof(f6926, plain, (sP6(sK60, sK57) | ~ spl61_3), inference(forward_demodulation, [], [f617, f567])).
...
fof(f8965, plain, (~ sP6(sK58, sK57) | spl61_254), inference(resolution, [], [f7616, f556])).
...
fof(f7616, plain, (~ ssList(sK55(sK58, sK57)) | spl61_254), inference(avatar_component_clause, [], [f7614])).
fof(f7614, plain, (spl61_254 <=> ssList(sK55(sK58, sK57))), introduced(avatar_definition, [new_symbols(naming, [spl61_254])])).
fof(f8937, plain, (~ spl61_3 | spl61_255), inference(avatar_contradiction_clause, [], [f8936])).
fof(f8936, plain, ($false | (~ spl61_3 | spl61_255)), inference(subsumption_resolution, [], [f8935, f6927])).
fof(f8935, plain, (~ sP6(sK58, sK57) | spl61_255), inference(resolution, [], [f7620, f557])).
fof(f557, plain, ! [X0, X1] : (ssList(sK56(X0, X1)) | ~ sP6(X0, X1)), inference(cnf_transformation, [], [f350])).
fof(f7620, plain, (~ ssList(sK56(sK58, sK57)) | spl61_255), inference(avatar_component_clause, [], [f7618])).
fof(f7618, plain, (spl61_255 <=> ssList(sK56(sK58, sK57))), introduced(avatar_definition, [new_symbols(naming, [spl61_255])])).
fof(f7621, plain, (~ spl61_254 | ~ spl61_255 | spl61_1 | ~ spl61_3), inference(avatar_split_clause, [], [f7612, f615, f606, f7618, f7614])).
fof(f606, plain, (spl61_1 <=> segmentP(sK58, sK57)), introduced(avatar_definition, [new_symbols(naming, [spl61_1])])).
fof(f7612, plain, (~ ssList(sK56(sK58, sK57)) | ~ ssList(sK55(sK58, sK57)) | (spl61_1 | ~ spl61_3)), inference(subsumption_resolution, [], [f7611, f628])).
...
fof(f7611, plain, (~ ssList(sK56(sK58, sK57)) | ~ ssList(sK55(sK58, sK57)) | ~ ssList(sK58) | (spl61_1 | ~ spl61_3)), inference(subsumption_resolution, [], [f7610, f629])).
...
fof(f7610, plain, (~ ssList(sK56(sK58, sK57)) | ~ ssList(sK55(sK58, sK57)) | ~ ssList(sK57) | ~ ssList(sK58) | (spl61_1 | ~ spl61_3)), inference(subsumption_resolution, [], [f7589, f608])).
fof(f608, plain, (~ segmentP(sK58, sK57) | spl61_1), inference(avatar_component_clause, [], [f606])).
fof(f7589, plain, (segmentP(sK58, sK57) | ~ ssList(sK56(sK58, sK57)) | ~ ssList(sK55(sK58, sK57)) | ~ ssList(sK57) | ~ ssList(sK58) | ~ spl61_3), inference(superposition, [], [f576, f7032])).
fof(f7032, plain, ((sK58 = app(app(sK55(sK58, sK57), sK57), sK56(sK58, sK57))) | ~ spl61_3), inference(resolution, [], [f6927, f559])).
...
fof(f7, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => (segmentP(X0, X1) <=> ? [X2] : (? [X3] : ((app(app(X2, X1), X3) = X0) & ssList(X3)) & ssList(X2))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC330+1.p', ax7)).
fof(f6867, plain, (spl61_2 | ~ spl61_23), inference(avatar_contradiction_clause, [], [f6866])).
fof(f6866, plain, ($false | (spl61_2 | ~ spl61_23)), inference(subsumption_resolution, [], [f6865, f527])).
fof(f527, plain, equalelemsP(nil), inference(cnf_transformation, [], [f74])).
fof(f74, plain, equalelemsP(nil), file('/home/ubuntu/library/tptp/Problems/SWC/SWC330+1.p', ax74)).
fof(f6865, plain, (~ equalelemsP(nil) | (spl61_2 | ~ spl61_23)), inference(forward_demodulation, [], [f612, f1151])).
...
fof(f612, plain, (~ equalelemsP(sK57) | spl61_2), inference(avatar_component_clause, [], [f610])).
fof(f610, plain, (spl61_2 <=> equalelemsP(sK57)), introduced(avatar_definition, [new_symbols(naming, [spl61_2])])).
...
fof(f17, plain, ssList(nil), file('/home/ubuntu/library/tptp/Problems/SWC/SWC330+1.p', ax17)).
...
fof(f55, plain, ! [X0] : (ssList(X0) => segmentP(X0, X0)), file('/home/ubuntu/library/tptp/Problems/SWC/SWC330+1.p', ax55)).
...
fof(f1611, plain, (~ spl61_28 | spl61_2 | ~ spl61_3), inference(avatar_split_clause, [], [f1574, f615, f610, f1596])).
fof(f1574, plain, (equalelemsP(sK57) | ~ ssItem(sK54(sK58, sK57)) | ~ spl61_3), inference(superposition, [], [f526, f1300])).
...
fof(f526, plain, ! [X0] : (equalelemsP(cons(X0, nil)) | ~ ssItem(X0)), inference(cnf_transformation, [], [f186])).
fof(f186, plain, ! [X0] : (equalelemsP(cons(X0, nil)) | ~ ssItem(X0)), inference(ennf_transformation, [], [f73])).
fof(f73, plain, ! [X0] : (ssItem(X0) => equalelemsP(cons(X0, nil))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC330+1.p', ax73)).
...
fof(f570, plain, (~ equalelemsP(sK57) | ~ segmentP(sK58, sK57)), inference(cnf_transformation, [], [f355])).