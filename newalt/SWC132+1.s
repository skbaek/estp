...
fof(f60, plain, cyclefreeP(nil), file('/home/ubuntu/library/tptp/Problems/SWC/SWC132+1.p', ax60)).
...
fof(f17, plain, ssList(nil), file('/home/ubuntu/library/tptp/Problems/SWC/SWC132+1.p', ax17)).
...
fof(f8, plain, ! [X0] : (ssList(X0) => (cyclefreeP(X0) <=> ! [X1] : (ssItem(X1) => ! [X2] : (ssItem(X2) => ! [X3] : (ssList(X3) => ! [X4] : (ssList(X4) => ! [X5] : (ssList(X5) => ((app(app(X3, cons(X1, X4)), cons(X2, X5)) = X0) => ~ (leq(X2, X1) & leq(X1, X2)))))))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC132+1.p', ax8)).
...
fof(f96, plain, ~ ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => ! [X2] : (ssList(X2) => ! [X3] : (ssList(X3) => (cyclefreeP(X1) | neq(X3, nil) | ~ (X0 = X2) | ~ (X1 = X3)))))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC132+1.p', co1)).
...
fof(f15, plain, ! [X0] : (ssList(X0) => ! [X1] : (ssList(X1) => (neq(X0, X1) <=> ~ (X0 = X1)))), file('/home/ubuntu/library/tptp/Problems/SWC/SWC132+1.p', ax15)).