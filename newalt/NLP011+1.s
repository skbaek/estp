...
fof(f608, plain, (~ spl22_18 | ~ spl22_19 | ~ spl22_20 | ~ spl22_21 | ~ spl22_22 | ~ spl22_23 | ~ spl22_86), inference(avatar_contradiction_clause, [], [f607])).
fof(f607, plain, ($false | (~ spl22_18 | ~ spl22_19 | ~ spl22_20 | ~ spl22_21 | ~ spl22_22 | ~ spl22_23 | ~ spl22_86)), inference(subsumption_resolution, [], [f606, f197])).
...
fof(f606, plain, (~ car(sK6) | (~ spl22_18 | ~ spl22_19 | ~ spl22_20 | ~ spl22_21 | ~ spl22_23 | ~ spl22_86)), inference(subsumption_resolution, [], [f605, f192])).
...
fof(f605, plain, (~ white(sK6) | ~ car(sK6) | (~ spl22_18 | ~ spl22_19 | ~ spl22_20 | ~ spl22_23 | ~ spl22_86)), inference(subsumption_resolution, [], [f604, f187])).
...
fof(f604, plain, (~ dirty(sK6) | ~ white(sK6) | ~ car(sK6) | (~ spl22_18 | ~ spl22_19 | ~ spl22_23 | ~ spl22_86)), inference(subsumption_resolution, [], [f603, f182])).
...
fof(f603, plain, (~ old(sK6) | ~ dirty(sK6) | ~ white(sK6) | ~ car(sK6) | (~ spl22_18 | ~ spl22_23 | ~ spl22_86)), inference(subsumption_resolution, [], [f602, f202])).
...
fof(f602, plain, (~ chevy(sK6) | ~ old(sK6) | ~ dirty(sK6) | ~ white(sK6) | ~ car(sK6) | (~ spl22_18 | ~ spl22_86)), inference(resolution, [], [f552, f177])).
fof(f177, plain, (barrel(sK4, sK6) | ~ spl22_18), inference(avatar_component_clause, [], [f175])).
fof(f175, plain, (spl22_18 <=> barrel(sK4, sK6)), introduced(avatar_definition, [new_symbols(naming, [spl22_18])])).
fof(f552, plain, (! [X1] : (~ barrel(sK4, X1) | ~ chevy(X1) | ~ old(X1) | ~ dirty(X1) | ~ white(X1) | ~ car(X1)) | ~ spl22_86), inference(avatar_component_clause, [], [f551])).
fof(f551, plain, (spl22_86 <=> ! [X1] : (~ chevy(X1) | ~ barrel(sK4, X1) | ~ old(X1) | ~ dirty(X1) | ~ white(X1) | ~ car(X1))), introduced(avatar_definition, [new_symbols(naming, [spl22_86])])).
fof(f601, plain, (~ spl22_17 | ~ spl22_24 | ~ spl22_25 | ~ spl22_26 | ~ spl22_87), inference(avatar_contradiction_clause, [], [f600])).
fof(f600, plain, ($false | (~ spl22_17 | ~ spl22_24 | ~ spl22_25 | ~ spl22_26 | ~ spl22_87)), inference(subsumption_resolution, [], [f599, f212])).
fof(f212, plain, (way(sK5) | ~ spl22_25), inference(avatar_component_clause, [], [f210])).
fof(f210, plain, (spl22_25 <=> way(sK5)), introduced(avatar_definition, [new_symbols(naming, [spl22_25])])).
fof(f599, plain, (~ way(sK5) | (~ spl22_17 | ~ spl22_24 | ~ spl22_26 | ~ spl22_87)), inference(subsumption_resolution, [], [f598, f207])).
fof(f207, plain, (lonely(sK5) | ~ spl22_24), inference(avatar_component_clause, [], [f205])).
fof(f205, plain, (spl22_24 <=> lonely(sK5)), introduced(avatar_definition, [new_symbols(naming, [spl22_24])])).
fof(f598, plain, (~ lonely(sK5) | ~ way(sK5) | (~ spl22_17 | ~ spl22_26 | ~ spl22_87)), inference(subsumption_resolution, [], [f597, f217])).
fof(f217, plain, (street(sK5) | ~ spl22_26), inference(avatar_component_clause, [], [f215])).
fof(f215, plain, (spl22_26 <=> street(sK5)), introduced(avatar_definition, [new_symbols(naming, [spl22_26])])).
fof(f597, plain, (~ street(sK5) | ~ lonely(sK5) | ~ way(sK5) | (~ spl22_17 | ~ spl22_87)), inference(resolution, [], [f555, f172])).
fof(f172, plain, (down(sK4, sK5) | ~ spl22_17), inference(avatar_component_clause, [], [f170])).
fof(f170, plain, (spl22_17 <=> down(sK4, sK5)), introduced(avatar_definition, [new_symbols(naming, [spl22_17])])).
fof(f555, plain, (! [X0] : (~ down(sK4, X0) | ~ street(X0) | ~ lonely(X0) | ~ way(X0)) | ~ spl22_87), inference(avatar_component_clause, [], [f554])).
fof(f554, plain, (spl22_87 <=> ! [X0] : (~ street(X0) | ~ down(sK4, X0) | ~ lonely(X0) | ~ way(X0))), introduced(avatar_definition, [new_symbols(naming, [spl22_87])])).
...
fof(f409, plain, (spl22_65 <=> ! [X11, X13, X12, X14] : (~ in(X12, X11) | ~ hollywood(X11) | ~ city(X11) | ~ event(X12) | ~ street(X13) | ~ way(X13) | ~ lonely(X13) | ~ chevy(X14) | ~ car(X14) | ~ white(X14) | ~ dirty(X14) | ~ old(X14) | ~ barrel(X12, X14) | ~ down(X12, X13))), introduced(avatar_definition, [new_symbols(naming, [spl22_65])])).
fof(f549, plain, (! [X0, X1] : (~ street(X0) | ~ way(X0) | ~ lonely(X0) | ~ chevy(X1) | ~ car(X1) | ~ white(X1) | ~ dirty(X1) | ~ old(X1) | ~ barrel(sK4, X1) | ~ down(sK4, X0)) | (~ spl22_16 | ~ spl22_27 | ~ spl22_28 | ~ spl22_29 | ~ spl22_65)), inference(subsumption_resolution, [], [f548, f222])).
fof(f222, plain, (event(sK4) | ~ spl22_27), inference(avatar_component_clause, [], [f220])).
fof(f548, plain, (! [X0, X1] : (~ event(sK4) | ~ street(X0) | ~ way(X0) | ~ lonely(X0) | ~ chevy(X1) | ~ car(X1) | ~ white(X1) | ~ dirty(X1) | ~ old(X1) | ~ barrel(sK4, X1) | ~ down(sK4, X0)) | (~ spl22_16 | ~ spl22_28 | ~ spl22_29 | ~ spl22_65)), inference(subsumption_resolution, [], [f547, f227])).
fof(f227, plain, (city(sK3) | ~ spl22_28), inference(avatar_component_clause, [], [f225])).
fof(f547, plain, (! [X0, X1] : (~ city(sK3) | ~ event(sK4) | ~ street(X0) | ~ way(X0) | ~ lonely(X0) | ~ chevy(X1) | ~ car(X1) | ~ white(X1) | ~ dirty(X1) | ~ old(X1) | ~ barrel(sK4, X1) | ~ down(sK4, X0)) | (~ spl22_16 | ~ spl22_29 | ~ spl22_65)), inference(subsumption_resolution, [], [f546, f232])).
fof(f232, plain, (hollywood(sK3) | ~ spl22_29), inference(avatar_component_clause, [], [f230])).
fof(f546, plain, (! [X0, X1] : (~ hollywood(sK3) | ~ city(sK3) | ~ event(sK4) | ~ street(X0) | ~ way(X0) | ~ lonely(X0) | ~ chevy(X1) | ~ car(X1) | ~ white(X1) | ~ dirty(X1) | ~ old(X1) | ~ barrel(sK4, X1) | ~ down(sK4, X0)) | (~ spl22_16 | ~ spl22_65)), inference(resolution, [], [f167, f410])).
fof(f410, plain, (! [X14, X12, X13, X11] : (~ in(X12, X11) | ~ hollywood(X11) | ~ city(X11) | ~ event(X12) | ~ street(X13) | ~ way(X13) | ~ lonely(X13) | ~ chevy(X14) | ~ car(X14) | ~ white(X14) | ~ dirty(X14) | ~ old(X14) | ~ barrel(X12, X14) | ~ down(X12, X13)) | ~ spl22_65), inference(avatar_component_clause, [], [f409])).
fof(f167, plain, (in(sK4, sK3) | ~ spl22_16), inference(avatar_component_clause, [], [f165])).
fof(f543, plain, (~ spl22_49 | ~ spl22_56 | ~ spl22_57 | ~ spl22_58 | ~ spl22_68), inference(avatar_contradiction_clause, [], [f542])).
fof(f542, plain, ($false | (~ spl22_49 | ~ spl22_56 | ~ spl22_57 | ~ spl22_58 | ~ spl22_68)), inference(subsumption_resolution, [], [f541, f371])).
fof(f371, plain, (way(sK15) | ~ spl22_57), inference(avatar_component_clause, [], [f369])).
fof(f369, plain, (spl22_57 <=> way(sK15)), introduced(avatar_definition, [new_symbols(naming, [spl22_57])])).
fof(f541, plain, (~ way(sK15) | (~ spl22_49 | ~ spl22_56 | ~ spl22_58 | ~ spl22_68)), inference(subsumption_resolution, [], [f540, f366])).
fof(f366, plain, (lonely(sK15) | ~ spl22_56), inference(avatar_component_clause, [], [f364])).
fof(f364, plain, (spl22_56 <=> lonely(sK15)), introduced(avatar_definition, [new_symbols(naming, [spl22_56])])).
fof(f540, plain, (~ lonely(sK15) | ~ way(sK15) | (~ spl22_49 | ~ spl22_58 | ~ spl22_68)), inference(subsumption_resolution, [], [f539, f376])).
fof(f376, plain, (street(sK15) | ~ spl22_58), inference(avatar_component_clause, [], [f374])).
fof(f374, plain, (spl22_58 <=> street(sK15)), introduced(avatar_definition, [new_symbols(naming, [spl22_58])])).
fof(f539, plain, (~ street(sK15) | ~ lonely(sK15) | ~ way(sK15) | (~ spl22_49 | ~ spl22_68)), inference(resolution, [], [f431, f331])).
fof(f331, plain, (down(sK14, sK15) | ~ spl22_49), inference(avatar_component_clause, [], [f329])).
fof(f329, plain, (spl22_49 <=> down(sK14, sK15)), introduced(avatar_definition, [new_symbols(naming, [spl22_49])])).
fof(f431, plain, (! [X0] : (~ down(sK14, X0) | ~ street(X0) | ~ lonely(X0) | ~ way(X0)) | ~ spl22_68), inference(avatar_component_clause, [], [f430])).
fof(f430, plain, (spl22_68 <=> ! [X0] : (~ street(X0) | ~ down(sK14, X0) | ~ lonely(X0) | ~ way(X0))), introduced(avatar_definition, [new_symbols(naming, [spl22_68])])).
fof(f538, plain, (spl22_67 | spl22_68 | ~ spl22_48 | ~ spl22_59 | ~ spl22_60 | ~ spl22_61 | ~ spl22_65), inference(avatar_split_clause, [], [f537, f409, f389, f384, f379, f324, f430, f427])).
fof(f427, plain, (spl22_67 <=> ! [X1] : (~ chevy(X1) | ~ barrel(sK14, X1) | ~ old(X1) | ~ dirty(X1) | ~ white(X1) | ~ car(X1))), introduced(avatar_definition, [new_symbols(naming, [spl22_67])])).
...
fof(f537, plain, (! [X0, X1] : (~ street(X0) | ~ way(X0) | ~ lonely(X0) | ~ chevy(X1) | ~ car(X1) | ~ white(X1) | ~ dirty(X1) | ~ old(X1) | ~ barrel(sK14, X1) | ~ down(sK14, X0)) | (~ spl22_48 | ~ spl22_59 | ~ spl22_60 | ~ spl22_61 | ~ spl22_65)), inference(subsumption_resolution, [], [f536, f381])).
fof(f381, plain, (event(sK14) | ~ spl22_59), inference(avatar_component_clause, [], [f379])).
fof(f536, plain, (! [X0, X1] : (~ event(sK14) | ~ street(X0) | ~ way(X0) | ~ lonely(X0) | ~ chevy(X1) | ~ car(X1) | ~ white(X1) | ~ dirty(X1) | ~ old(X1) | ~ barrel(sK14, X1) | ~ down(sK14, X0)) | (~ spl22_48 | ~ spl22_60 | ~ spl22_61 | ~ spl22_65)), inference(subsumption_resolution, [], [f535, f386])).
fof(f386, plain, (city(sK13) | ~ spl22_60), inference(avatar_component_clause, [], [f384])).
fof(f535, plain, (! [X0, X1] : (~ city(sK13) | ~ event(sK14) | ~ street(X0) | ~ way(X0) | ~ lonely(X0) | ~ chevy(X1) | ~ car(X1) | ~ white(X1) | ~ dirty(X1) | ~ old(X1) | ~ barrel(sK14, X1) | ~ down(sK14, X0)) | (~ spl22_48 | ~ spl22_61 | ~ spl22_65)), inference(subsumption_resolution, [], [f525, f391])).
fof(f391, plain, (hollywood(sK13) | ~ spl22_61), inference(avatar_component_clause, [], [f389])).
fof(f525, plain, (! [X0, X1] : (~ hollywood(sK13) | ~ city(sK13) | ~ event(sK14) | ~ street(X0) | ~ way(X0) | ~ lonely(X0) | ~ chevy(X1) | ~ car(X1) | ~ white(X1) | ~ dirty(X1) | ~ old(X1) | ~ barrel(sK14, X1) | ~ down(sK14, X0)) | (~ spl22_48 | ~ spl22_65)), inference(resolution, [], [f410, f326])).
fof(f326, plain, (in(sK14, sK13) | ~ spl22_48), inference(avatar_component_clause, [], [f324])).
fof(f534, plain, (~ spl22_50 | ~ spl22_51 | ~ spl22_52 | ~ spl22_53 | ~ spl22_54 | ~ spl22_55 | ~ spl22_67), inference(avatar_contradiction_clause, [], [f533])).
fof(f533, plain, ($false | (~ spl22_50 | ~ spl22_51 | ~ spl22_52 | ~ spl22_53 | ~ spl22_54 | ~ spl22_55 | ~ spl22_67)), inference(subsumption_resolution, [], [f532, f356])).
fof(f356, plain, (car(sK16) | ~ spl22_54), inference(avatar_component_clause, [], [f354])).
fof(f354, plain, (spl22_54 <=> car(sK16)), introduced(avatar_definition, [new_symbols(naming, [spl22_54])])).
fof(f532, plain, (~ car(sK16) | (~ spl22_50 | ~ spl22_51 | ~ spl22_52 | ~ spl22_53 | ~ spl22_55 | ~ spl22_67)), inference(subsumption_resolution, [], [f531, f351])).
fof(f351, plain, (white(sK16) | ~ spl22_53), inference(avatar_component_clause, [], [f349])).
fof(f349, plain, (spl22_53 <=> white(sK16)), introduced(avatar_definition, [new_symbols(naming, [spl22_53])])).
fof(f531, plain, (~ white(sK16) | ~ car(sK16) | (~ spl22_50 | ~ spl22_51 | ~ spl22_52 | ~ spl22_55 | ~ spl22_67)), inference(subsumption_resolution, [], [f530, f346])).
fof(f346, plain, (dirty(sK16) | ~ spl22_52), inference(avatar_component_clause, [], [f344])).
fof(f344, plain, (spl22_52 <=> dirty(sK16)), introduced(avatar_definition, [new_symbols(naming, [spl22_52])])).
fof(f530, plain, (~ dirty(sK16) | ~ white(sK16) | ~ car(sK16) | (~ spl22_50 | ~ spl22_51 | ~ spl22_55 | ~ spl22_67)), inference(subsumption_resolution, [], [f529, f341])).
fof(f341, plain, (old(sK16) | ~ spl22_51), inference(avatar_component_clause, [], [f339])).
fof(f339, plain, (spl22_51 <=> old(sK16)), introduced(avatar_definition, [new_symbols(naming, [spl22_51])])).
fof(f529, plain, (~ old(sK16) | ~ dirty(sK16) | ~ white(sK16) | ~ car(sK16) | (~ spl22_50 | ~ spl22_55 | ~ spl22_67)), inference(subsumption_resolution, [], [f528, f361])).
fof(f361, plain, (chevy(sK16) | ~ spl22_55), inference(avatar_component_clause, [], [f359])).
fof(f359, plain, (spl22_55 <=> chevy(sK16)), introduced(avatar_definition, [new_symbols(naming, [spl22_55])])).
fof(f528, plain, (~ chevy(sK16) | ~ old(sK16) | ~ dirty(sK16) | ~ white(sK16) | ~ car(sK16) | (~ spl22_50 | ~ spl22_67)), inference(resolution, [], [f428, f336])).
fof(f336, plain, (barrel(sK14, sK16) | ~ spl22_50), inference(avatar_component_clause, [], [f334])).
fof(f334, plain, (spl22_50 <=> barrel(sK14, sK16)), introduced(avatar_definition, [new_symbols(naming, [spl22_50])])).
fof(f428, plain, (! [X1] : (~ barrel(sK14, X1) | ~ chevy(X1) | ~ old(X1) | ~ dirty(X1) | ~ white(X1) | ~ car(X1)) | ~ spl22_67), inference(avatar_component_clause, [], [f427])).
...
fof(f15, plain, ((! [X0, X1, X2, X3, X4, X5, X6, X7, X8, X9] : (~ in(X9, X0) | ~ (X6 = X9) | ~ in(X8, X7) | ~ (X5 = X8) | ~ young(X6) | ~ man(X6) | ~ fellow(X6) | ~ young(X5) | ~ man(X5) | ~ fellow(X5) | (X5 = X6) | ~ front(X7) | ~ furniture(X7) | ~ seat(X7) | ~ in(X2, X1) | ~ down(X2, X3) | ~ barrel(X2, X4) | ~ old(X4) | ~ dirty(X4) | ~ white(X4) | ~ car(X4) | ~ chevy(X4) | ~ lonely(X3) | ~ way(X3) | ~ street(X3) | ~ event(X2) | ~ city(X1) | ~ hollywood(X1) | ~ front(X0) | ~ furniture(X0) | ~ seat(X0)) & sP1) | (! [X10, X11, X12, X13, X14, X15, X16, X17, X18, X19] : (~ in(X19, X17) | ~ (X16 = X19) | ~ in(X18, X10) | ~ (X15 = X18) | ~ young(X16) | ~ man(X16) | ~ fellow(X16) | ~ young(X15) | ~ man(X15) | ~ fellow(X15) | (X15 = X16) | ~ front(X17) | ~ furniture(X17) | ~ seat(X17) | ~ in(X12, X11) | ~ down(X12, X13) | ~ barrel(X12, X14) | ~ old(X14) | ~ dirty(X14) | ~ white(X14) | ~ car(X14) | ~ chevy(X14) | ~ lonely(X13) | ~ way(X13) | ~ street(X13) | ~ event(X12) | ~ city(X11) | ~ hollywood(X11) | ~ front(X10) | ~ furniture(X10) | ~ seat(X10)) & sP0)), inference(rectify, [], [f7])).
fof(f7, plain, ((! [X10, X11, X12, X13, X14, X15, X16, X17, X18, X19] : (~ in(X19, X10) | ~ (X16 = X19) | ~ in(X18, X17) | ~ (X15 = X18) | ~ young(X16) | ~ man(X16) | ~ fellow(X16) | ~ young(X15) | ~ man(X15) | ~ fellow(X15) | (X15 = X16) | ~ front(X17) | ~ furniture(X17) | ~ seat(X17) | ~ in(X12, X11) | ~ down(X12, X13) | ~ barrel(X12, X14) | ~ old(X14) | ~ dirty(X14) | ~ white(X14) | ~ car(X14) | ~ chevy(X14) | ~ lonely(X13) | ~ way(X13) | ~ street(X13) | ~ event(X12) | ~ city(X11) | ~ hollywood(X11) | ~ front(X10) | ~ furniture(X10) | ~ seat(X10)) & sP1) | (! [X30, X31, X32, X33, X34, X35, X36, X37, X38, X39] : (~ in(X39, X37) | ~ (X36 = X39) | ~ in(X38, X30) | ~ (X35 = X38) | ~ young(X36) | ~ man(X36) | ~ fellow(X36) | ~ young(X35) | ~ man(X35) | ~ fellow(X35) | (X35 = X36) | ~ front(X37) | ~ furniture(X37) | ~ seat(X37) | ~ in(X32, X31) | ~ down(X32, X33) | ~ barrel(X32, X34) | ~ old(X34) | ~ dirty(X34) | ~ white(X34) | ~ car(X34) | ~ chevy(X34) | ~ lonely(X33) | ~ way(X33) | ~ street(X33) | ~ event(X32) | ~ city(X31) | ~ hollywood(X31) | ~ front(X30) | ~ furniture(X30) | ~ seat(X30)) & sP0)), inference(definition_folding, [], [f4, e6, e5])).
fof(f5, plain, (? [X20, X21, X22, X23, X24, X25, X26, X27, X28, X29] : (in(X29, X20) & (X26 = X29) & in(X28, X27) & (X25 = X28) & young(X26) & man(X26) & fellow(X26) & young(X25) & man(X25) & fellow(X25) & ~ (X25 = X26) & front(X27) & furniture(X27) & seat(X27) & in(X22, X21) & down(X22, X23) & barrel(X22, X24) & old(X24) & dirty(X24) & white(X24) & car(X24) & chevy(X24) & lonely(X23) & way(X23) & street(X23) & event(X22) & city(X21) & hollywood(X21) & front(X20) & furniture(X20) & seat(X20)) | ~ sP0), inference(usedef, [], [e5])).
fof(e5, plain, (sP0 <=> ? [X20, X21, X22, X23, X24, X25, X26, X27, X28, X29] : (in(X29, X20) & (X26 = X29) & in(X28, X27) & (X25 = X28) & young(X26) & man(X26) & fellow(X26) & young(X25) & man(X25) & fellow(X25) & ~ (X25 = X26) & front(X27) & furniture(X27) & seat(X27) & in(X22, X21) & down(X22, X23) & barrel(X22, X24) & old(X24) & dirty(X24) & white(X24) & car(X24) & chevy(X24) & lonely(X23) & way(X23) & street(X23) & event(X22) & city(X21) & hollywood(X21) & front(X20) & furniture(X20) & seat(X20))), introduced(predicate_definition_introduction, [new_symbols(naming, [sP0])])).
fof(f6, plain, (? [X0, X1, X2, X3, X4, X5, X6, X7, X8, X9] : (in(X9, X7) & (X6 = X9) & in(X8, X0) & (X5 = X8) & young(X6) & man(X6) & fellow(X6) & young(X5) & man(X5) & fellow(X5) & ~ (X5 = X6) & front(X7) & furniture(X7) & seat(X7) & in(X2, X1) & down(X2, X3) & barrel(X2, X4) & old(X4) & dirty(X4) & white(X4) & car(X4) & chevy(X4) & lonely(X3) & way(X3) & street(X3) & event(X2) & city(X1) & hollywood(X1) & front(X0) & furniture(X0) & seat(X0)) | ~ sP1), inference(usedef, [], [e6])).
fof(e6, plain, (sP1 <=> ? [X0, X1, X2, X3, X4, X5, X6, X7, X8, X9] : (in(X9, X7) & (X6 = X9) & in(X8, X0) & (X5 = X8) & young(X6) & man(X6) & fellow(X6) & young(X5) & man(X5) & fellow(X5) & ~ (X5 = X6) & front(X7) & furniture(X7) & seat(X7) & in(X2, X1) & down(X2, X3) & barrel(X2, X4) & old(X4) & dirty(X4) & white(X4) & car(X4) & chevy(X4) & lonely(X3) & way(X3) & street(X3) & event(X2) & city(X1) & hollywood(X1) & front(X0) & furniture(X0) & seat(X0))), introduced(predicate_definition_introduction, [new_symbols(naming, [sP1])])).
fof(f4, plain, ((! [X10, X11, X12, X13, X14, X15, X16, X17, X18, X19] : (~ in(X19, X10) | ~ (X16 = X19) | ~ in(X18, X17) | ~ (X15 = X18) | ~ young(X16) | ~ man(X16) | ~ fellow(X16) | ~ young(X15) | ~ man(X15) | ~ fellow(X15) | (X15 = X16) | ~ front(X17) | ~ furniture(X17) | ~ seat(X17) | ~ in(X12, X11) | ~ down(X12, X13) | ~ barrel(X12, X14) | ~ old(X14) | ~ dirty(X14) | ~ white(X14) | ~ car(X14) | ~ chevy(X14) | ~ lonely(X13) | ~ way(X13) | ~ street(X13) | ~ event(X12) | ~ city(X11) | ~ hollywood(X11) | ~ front(X10) | ~ furniture(X10) | ~ seat(X10)) & ? [X0, X1, X2, X3, X4, X5, X6, X7, X8, X9] : (in(X9, X7) & (X6 = X9) & in(X8, X0) & (X5 = X8) & young(X6) & man(X6) & fellow(X6) & young(X5) & man(X5) & fellow(X5) & ~ (X5 = X6) & front(X7) & furniture(X7) & seat(X7) & in(X2, X1) & down(X2, X3) & barrel(X2, X4) & old(X4) & dirty(X4) & white(X4) & car(X4) & chevy(X4) & lonely(X3) & way(X3) & street(X3) & event(X2) & city(X1) & hollywood(X1) & front(X0) & furniture(X0) & seat(X0))) | (! [X30, X31, X32, X33, X34, X35, X36, X37, X38, X39] : (~ in(X39, X37) | ~ (X36 = X39) | ~ in(X38, X30) | ~ (X35 = X38) | ~ young(X36) | ~ man(X36) | ~ fellow(X36) | ~ young(X35) | ~ man(X35) | ~ fellow(X35) | (X35 = X36) | ~ front(X37) | ~ furniture(X37) | ~ seat(X37) | ~ in(X32, X31) | ~ down(X32, X33) | ~ barrel(X32, X34) | ~ old(X34) | ~ dirty(X34) | ~ white(X34) | ~ car(X34) | ~ chevy(X34) | ~ lonely(X33) | ~ way(X33) | ~ street(X33) | ~ event(X32) | ~ city(X31) | ~ hollywood(X31) | ~ front(X30) | ~ furniture(X30) | ~ seat(X30)) & ? [X20, X21, X22, X23, X24, X25, X26, X27, X28, X29] : (in(X29, X20) & (X26 = X29) & in(X28, X27) & (X25 = X28) & young(X26) & man(X26) & fellow(X26) & young(X25) & man(X25) & fellow(X25) & ~ (X25 = X26) & front(X27) & furniture(X27) & seat(X27) & in(X22, X21) & down(X22, X23) & barrel(X22, X24) & old(X24) & dirty(X24) & white(X24) & car(X24) & chevy(X24) & lonely(X23) & way(X23) & street(X23) & event(X22) & city(X21) & hollywood(X21) & front(X20) & furniture(X20) & seat(X20)))), inference(ennf_transformation, [], [f3])).
fof(f3, plain, ~ ((? [X0, X1, X2, X3, X4, X5, X6, X7, X8, X9] : (in(X9, X7) & (X6 = X9) & in(X8, X0) & (X5 = X8) & young(X6) & man(X6) & fellow(X6) & young(X5) & man(X5) & fellow(X5) & ~ (X5 = X6) & front(X7) & furniture(X7) & seat(X7) & in(X2, X1) & down(X2, X3) & barrel(X2, X4) & old(X4) & dirty(X4) & white(X4) & car(X4) & chevy(X4) & lonely(X3) & way(X3) & street(X3) & event(X2) & city(X1) & hollywood(X1) & front(X0) & furniture(X0) & seat(X0)) => ? [X10, X11, X12, X13, X14, X15, X16, X17, X18, X19] : (in(X19, X10) & (X16 = X19) & in(X18, X17) & (X15 = X18) & young(X16) & man(X16) & fellow(X16) & young(X15) & man(X15) & fellow(X15) & ~ (X15 = X16) & front(X17) & furniture(X17) & seat(X17) & in(X12, X11) & down(X12, X13) & barrel(X12, X14) & old(X14) & dirty(X14) & white(X14) & car(X14) & chevy(X14) & lonely(X13) & way(X13) & street(X13) & event(X12) & city(X11) & hollywood(X11) & front(X10) & furniture(X10) & seat(X10))) & (? [X20, X21, X22, X23, X24, X25, X26, X27, X28, X29] : (in(X29, X20) & (X26 = X29) & in(X28, X27) & (X25 = X28) & young(X26) & man(X26) & fellow(X26) & young(X25) & man(X25) & fellow(X25) & ~ (X25 = X26) & front(X27) & furniture(X27) & seat(X27) & in(X22, X21) & down(X22, X23) & barrel(X22, X24) & old(X24) & dirty(X24) & white(X24) & car(X24) & chevy(X24) & lonely(X23) & way(X23) & street(X23) & event(X22) & city(X21) & hollywood(X21) & front(X20) & furniture(X20) & seat(X20)) => ? [X30, X31, X32, X33, X34, X35, X36, X37, X38, X39] : (in(X39, X37) & (X36 = X39) & in(X38, X30) & (X35 = X38) & young(X36) & man(X36) & fellow(X36) & young(X35) & man(X35) & fellow(X35) & ~ (X35 = X36) & front(X37) & furniture(X37) & seat(X37) & in(X32, X31) & down(X32, X33) & barrel(X32, X34) & old(X34) & dirty(X34) & white(X34) & car(X34) & chevy(X34) & lonely(X33) & way(X33) & street(X33) & event(X32) & city(X31) & hollywood(X31) & front(X30) & furniture(X30) & seat(X30)))), inference(rectify, [], [f2])).
fof(f2, plain, ~ ((? [X20, X21, X22, X23, X24, X25, X26, X27, X28, X29] : (in(X29, X27) & (X26 = X29) & in(X28, X20) & (X25 = X28) & young(X26) & man(X26) & fellow(X26) & young(X25) & man(X25) & fellow(X25) & ~ (X25 = X26) & front(X27) & furniture(X27) & seat(X27) & in(X22, X21) & down(X22, X23) & barrel(X22, X24) & old(X24) & dirty(X24) & white(X24) & car(X24) & chevy(X24) & lonely(X23) & way(X23) & street(X23) & event(X22) & city(X21) & hollywood(X21) & front(X20) & furniture(X20) & seat(X20)) => ? [X30, X31, X32, X33, X34, X35, X36, X37, X38, X39] : (in(X39, X30) & (X36 = X39) & in(X38, X37) & (X35 = X38) & young(X36) & man(X36) & fellow(X36) & young(X35) & man(X35) & fellow(X35) & ~ (X35 = X36) & front(X37) & furniture(X37) & seat(X37) & in(X32, X31) & down(X32, X33) & barrel(X32, X34) & old(X34) & dirty(X34) & white(X34) & car(X34) & chevy(X34) & lonely(X33) & way(X33) & street(X33) & event(X32) & city(X31) & hollywood(X31) & front(X30) & furniture(X30) & seat(X30))) & (? [X0, X1, X2, X3, X4, X5, X6, X7, X8, X9] : (in(X9, X0) & (X6 = X9) & in(X8, X7) & (X5 = X8) & young(X6) & man(X6) & fellow(X6) & young(X5) & man(X5) & fellow(X5) & ~ (X5 = X6) & front(X7) & furniture(X7) & seat(X7) & in(X2, X1) & down(X2, X3) & barrel(X2, X4) & old(X4) & dirty(X4) & white(X4) & car(X4) & chevy(X4) & lonely(X3) & way(X3) & street(X3) & event(X2) & city(X1) & hollywood(X1) & front(X0) & furniture(X0) & seat(X0)) => ? [X10, X11, X12, X13, X14, X15, X16, X17, X18, X19] : (in(X19, X17) & (X16 = X19) & in(X18, X10) & (X15 = X18) & young(X16) & man(X16) & fellow(X16) & young(X15) & man(X15) & fellow(X15) & ~ (X15 = X16) & front(X17) & furniture(X17) & seat(X17) & in(X12, X11) & down(X12, X13) & barrel(X12, X14) & old(X14) & dirty(X14) & white(X14) & car(X14) & chevy(X14) & lonely(X13) & way(X13) & street(X13) & event(X12) & city(X11) & hollywood(X11) & front(X10) & furniture(X10) & seat(X10)))), inference(negated_conjecture, [], [f1])).
fof(f1, plain, ~ ((? [X20, X21, X22, X23, X24, X25, X26, X27, X28, X29] : (in(X29, X27) & (X26 = X29) & in(X28, X20) & (X25 = X28) & young(X26) & man(X26) & fellow(X26) & young(X25) & man(X25) & fellow(X25) & ~ (X25 = X26) & front(X27) & furniture(X27) & seat(X27) & in(X22, X21) & down(X22, X23) & barrel(X22, X24) & old(X24) & dirty(X24) & white(X24) & car(X24) & chevy(X24) & lonely(X23) & way(X23) & street(X23) & event(X22) & city(X21) & hollywood(X21) & front(X20) & furniture(X20) & seat(X20)) => ? [X30, X31, X32, X33, X34, X35, X36, X37, X38, X39] : (in(X39, X30) & (X36 = X39) & in(X38, X37) & (X35 = X38) & young(X36) & man(X36) & fellow(X36) & young(X35) & man(X35) & fellow(X35) & ~ (X35 = X36) & front(X37) & furniture(X37) & seat(X37) & in(X32, X31) & down(X32, X33) & barrel(X32, X34) & old(X34) & dirty(X34) & white(X34) & car(X34) & chevy(X34) & lonely(X33) & way(X33) & street(X33) & event(X32) & city(X31) & hollywood(X31) & front(X30) & furniture(X30) & seat(X30))) & (? [X0, X1, X2, X3, X4, X5, X6, X7, X8, X9] : (in(X9, X0) & (X6 = X9) & in(X8, X7) & (X5 = X8) & young(X6) & man(X6) & fellow(X6) & young(X5) & man(X5) & fellow(X5) & ~ (X5 = X6) & front(X7) & furniture(X7) & seat(X7) & in(X2, X1) & down(X2, X3) & barrel(X2, X4) & old(X4) & dirty(X4) & white(X4) & car(X4) & chevy(X4) & lonely(X3) & way(X3) & street(X3) & event(X2) & city(X1) & hollywood(X1) & front(X0) & furniture(X0) & seat(X0)) => ? [X10, X11, X12, X13, X14, X15, X16, X17, X18, X19] : (in(X19, X17) & (X16 = X19) & in(X18, X10) & (X15 = X18) & young(X16) & man(X16) & fellow(X16) & young(X15) & man(X15) & fellow(X15) & ~ (X15 = X16) & front(X17) & furniture(X17) & seat(X17) & in(X12, X11) & down(X12, X13) & barrel(X12, X14) & old(X14) & dirty(X14) & white(X14) & car(X14) & chevy(X14) & lonely(X13) & way(X13) & street(X13) & event(X12) & city(X11) & hollywood(X11) & front(X10) & furniture(X10) & seat(X10)))), file('/home/ubuntu/library/tptp/Problems/NLP/NLP011+1.p', co1)).
fof(f414, plain, (spl22_65 | spl22_66 | spl22_65 | spl22_66), inference(avatar_split_clause, [], [f85, f412, f409, f412, f409])).
fof(f85, plain, ! [X4, X2, X0, X14, X12, X10, X8, X19, X17, X7, X3, X1, X13, X11, X9, X18] : (~ in(X9, X0) | ~ in(X8, X7) | ~ young(X9) | ~ man(X9) | ~ fellow(X9) | ~ young(X8) | ~ man(X8) | ~ fellow(X8) | (X8 = X9) | ~ front(X7) | ~ furniture(X7) | ~ seat(X7) | ~ in(X2, X1) | ~ down(X2, X3) | ~ barrel(X2, X4) | ~ old(X4) | ~ dirty(X4) | ~ white(X4) | ~ car(X4) | ~ chevy(X4) | ~ lonely(X3) | ~ way(X3) | ~ street(X3) | ~ event(X2) | ~ city(X1) | ~ hollywood(X1) | ~ front(X0) | ~ furniture(X0) | ~ seat(X0) | ~ in(X19, X17) | ~ in(X18, X10) | ~ young(X19) | ~ man(X19) | ~ fellow(X19) | ~ young(X18) | ~ man(X18) | ~ fellow(X18) | (X18 = X19) | ~ front(X17) | ~ furniture(X17) | ~ seat(X17) | ~ in(X12, X11) | ~ down(X12, X13) | ~ barrel(X12, X14) | ~ old(X14) | ~ dirty(X14) | ~ white(X14) | ~ car(X14) | ~ chevy(X14) | ~ lonely(X13) | ~ way(X13) | ~ street(X13) | ~ event(X12) | ~ city(X11) | ~ hollywood(X11) | ~ front(X10) | ~ furniture(X10) | ~ seat(X10)), inference(equality_resolution, [], [f84])).
fof(f84, plain, ! [X4, X2, X0, X14, X12, X10, X8, X19, X17, X7, X3, X1, X15, X13, X11, X9, X18] : (~ in(X9, X0) | ~ in(X8, X7) | ~ young(X9) | ~ man(X9) | ~ fellow(X9) | ~ young(X8) | ~ man(X8) | ~ fellow(X8) | (X8 = X9) | ~ front(X7) | ~ furniture(X7) | ~ seat(X7) | ~ in(X2, X1) | ~ down(X2, X3) | ~ barrel(X2, X4) | ~ old(X4) | ~ dirty(X4) | ~ white(X4) | ~ car(X4) | ~ chevy(X4) | ~ lonely(X3) | ~ way(X3) | ~ street(X3) | ~ event(X2) | ~ city(X1) | ~ hollywood(X1) | ~ front(X0) | ~ furniture(X0) | ~ seat(X0) | ~ in(X19, X17) | ~ in(X18, X10) | ~ (X15 = X18) | ~ young(X19) | ~ man(X19) | ~ fellow(X19) | ~ young(X15) | ~ man(X15) | ~ fellow(X15) | (X15 = X19) | ~ front(X17) | ~ furniture(X17) | ~ seat(X17) | ~ in(X12, X11) | ~ down(X12, X13) | ~ barrel(X12, X14) | ~ old(X14) | ~ dirty(X14) | ~ white(X14) | ~ car(X14) | ~ chevy(X14) | ~ lonely(X13) | ~ way(X13) | ~ street(X13) | ~ event(X12) | ~ city(X11) | ~ hollywood(X11) | ~ front(X10) | ~ furniture(X10) | ~ seat(X10)), inference(equality_resolution, [], [f83])).
fof(f83, plain, ! [X4, X2, X0, X14, X12, X10, X8, X19, X17, X7, X3, X1, X15, X13, X11, X9, X18, X16] : (~ in(X9, X0) | ~ in(X8, X7) | ~ young(X9) | ~ man(X9) | ~ fellow(X9) | ~ young(X8) | ~ man(X8) | ~ fellow(X8) | (X8 = X9) | ~ front(X7) | ~ furniture(X7) | ~ seat(X7) | ~ in(X2, X1) | ~ down(X2, X3) | ~ barrel(X2, X4) | ~ old(X4) | ~ dirty(X4) | ~ white(X4) | ~ car(X4) | ~ chevy(X4) | ~ lonely(X3) | ~ way(X3) | ~ street(X3) | ~ event(X2) | ~ city(X1) | ~ hollywood(X1) | ~ front(X0) | ~ furniture(X0) | ~ seat(X0) | ~ in(X19, X17) | ~ (X16 = X19) | ~ in(X18, X10) | ~ (X15 = X18) | ~ young(X16) | ~ man(X16) | ~ fellow(X16) | ~ young(X15) | ~ man(X15) | ~ fellow(X15) | (X15 = X16) | ~ front(X17) | ~ furniture(X17) | ~ seat(X17) | ~ in(X12, X11) | ~ down(X12, X13) | ~ barrel(X12, X14) | ~ old(X14) | ~ dirty(X14) | ~ white(X14) | ~ car(X14) | ~ chevy(X14) | ~ lonely(X13) | ~ way(X13) | ~ street(X13) | ~ event(X12) | ~ city(X11) | ~ hollywood(X11) | ~ front(X10) | ~ furniture(X10) | ~ seat(X10)), inference(equality_resolution, [], [f82])).
fof(f82, plain, ! [X4, X2, X0, X14, X12, X10, X8, X19, X17, X7, X5, X3, X1, X15, X13, X11, X9, X18, X16] : (~ in(X9, X0) | ~ in(X8, X7) | ~ (X5 = X8) | ~ young(X9) | ~ man(X9) | ~ fellow(X9) | ~ young(X5) | ~ man(X5) | ~ fellow(X5) | (X5 = X9) | ~ front(X7) | ~ furniture(X7) | ~ seat(X7) | ~ in(X2, X1) | ~ down(X2, X3) | ~ barrel(X2, X4) | ~ old(X4) | ~ dirty(X4) | ~ white(X4) | ~ car(X4) | ~ chevy(X4) | ~ lonely(X3) | ~ way(X3) | ~ street(X3) | ~ event(X2) | ~ city(X1) | ~ hollywood(X1) | ~ front(X0) | ~ furniture(X0) | ~ seat(X0) | ~ in(X19, X17) | ~ (X16 = X19) | ~ in(X18, X10) | ~ (X15 = X18) | ~ young(X16) | ~ man(X16) | ~ fellow(X16) | ~ young(X15) | ~ man(X15) | ~ fellow(X15) | (X15 = X16) | ~ front(X17) | ~ furniture(X17) | ~ seat(X17) | ~ in(X12, X11) | ~ down(X12, X13) | ~ barrel(X12, X14) | ~ old(X14) | ~ dirty(X14) | ~ white(X14) | ~ car(X14) | ~ chevy(X14) | ~ lonely(X13) | ~ way(X13) | ~ street(X13) | ~ event(X12) | ~ city(X11) | ~ hollywood(X11) | ~ front(X10) | ~ furniture(X10) | ~ seat(X10)), inference(equality_resolution, [], [f81])).
fof(f81, plain, ! [X6, X4, X2, X0, X14, X12, X10, X8, X19, X17, X7, X5, X3, X1, X15, X13, X11, X9, X18, X16] : (~ in(X9, X0) | ~ (X6 = X9) | ~ in(X8, X7) | ~ (X5 = X8) | ~ young(X6) | ~ man(X6) | ~ fellow(X6) | ~ young(X5) | ~ man(X5) | ~ fellow(X5) | (X5 = X6) | ~ front(X7) | ~ furniture(X7) | ~ seat(X7) | ~ in(X2, X1) | ~ down(X2, X3) | ~ barrel(X2, X4) | ~ old(X4) | ~ dirty(X4) | ~ white(X4) | ~ car(X4) | ~ chevy(X4) | ~ lonely(X3) | ~ way(X3) | ~ street(X3) | ~ event(X2) | ~ city(X1) | ~ hollywood(X1) | ~ front(X0) | ~ furniture(X0) | ~ seat(X0) | ~ in(X19, X17) | ~ (X16 = X19) | ~ in(X18, X10) | ~ (X15 = X18) | ~ young(X16) | ~ man(X16) | ~ fellow(X16) | ~ young(X15) | ~ man(X15) | ~ fellow(X15) | (X15 = X16) | ~ front(X17) | ~ furniture(X17) | ~ seat(X17) | ~ in(X12, X11) | ~ down(X12, X13) | ~ barrel(X12, X14) | ~ old(X14) | ~ dirty(X14) | ~ white(X14) | ~ car(X14) | ~ chevy(X14) | ~ lonely(X13) | ~ way(X13) | ~ street(X13) | ~ event(X12) | ~ city(X11) | ~ hollywood(X11) | ~ front(X10) | ~ furniture(X10) | ~ seat(X10)), inference(cnf_transformation, [], [f15])).
...
fof(f14, plain, ((in(sK21, sK12) & (sK18 = sK21) & in(sK20, sK19) & (sK17 = sK20) & young(sK18) & man(sK18) & fellow(sK18) & young(sK17) & man(sK17) & fellow(sK17) & ~ (sK17 = sK18) & front(sK19) & furniture(sK19) & seat(sK19) & in(sK14, sK13) & down(sK14, sK15) & barrel(sK14, sK16) & old(sK16) & dirty(sK16) & white(sK16) & car(sK16) & chevy(sK16) & lonely(sK15) & way(sK15) & street(sK15) & event(sK14) & city(sK13) & hollywood(sK13) & front(sK12) & furniture(sK12) & seat(sK12)) | ~ sP0), inference(skolemisation, [status(esa), new_symbols(skolem, [sK12, sK13, sK14, sK15, sK16, sK17, sK18, sK19, sK20, sK21])], [f12, f13])).
fof(f13, plain, (? [X0, X1, X2, X3, X4, X5, X6, X7, X8, X9] : (in(X9, X0) & (X6 = X9) & in(X8, X7) & (X5 = X8) & young(X6) & man(X6) & fellow(X6) & young(X5) & man(X5) & fellow(X5) & ~ (X5 = X6) & front(X7) & furniture(X7) & seat(X7) & in(X2, X1) & down(X2, X3) & barrel(X2, X4) & old(X4) & dirty(X4) & white(X4) & car(X4) & chevy(X4) & lonely(X3) & way(X3) & street(X3) & event(X2) & city(X1) & hollywood(X1) & front(X0) & furniture(X0) & seat(X0)) => (in(sK21, sK12) & (sK18 = sK21) & in(sK20, sK19) & (sK17 = sK20) & young(sK18) & man(sK18) & fellow(sK18) & young(sK17) & man(sK17) & fellow(sK17) & ~ (sK17 = sK18) & front(sK19) & furniture(sK19) & seat(sK19) & in(sK14, sK13) & down(sK14, sK15) & barrel(sK14, sK16) & old(sK16) & dirty(sK16) & white(sK16) & car(sK16) & chevy(sK16) & lonely(sK15) & way(sK15) & street(sK15) & event(sK14) & city(sK13) & hollywood(sK13) & front(sK12) & furniture(sK12) & seat(sK12))), introduced(choice_axiom, [])).
fof(f12, plain, (? [X0, X1, X2, X3, X4, X5, X6, X7, X8, X9] : (in(X9, X0) & (X6 = X9) & in(X8, X7) & (X5 = X8) & young(X6) & man(X6) & fellow(X6) & young(X5) & man(X5) & fellow(X5) & ~ (X5 = X6) & front(X7) & furniture(X7) & seat(X7) & in(X2, X1) & down(X2, X3) & barrel(X2, X4) & old(X4) & dirty(X4) & white(X4) & car(X4) & chevy(X4) & lonely(X3) & way(X3) & street(X3) & event(X2) & city(X1) & hollywood(X1) & front(X0) & furniture(X0) & seat(X0)) | ~ sP0), inference(rectify, [], [f11])).
fof(f11, plain, (? [X20, X21, X22, X23, X24, X25, X26, X27, X28, X29] : (in(X29, X20) & (X26 = X29) & in(X28, X27) & (X25 = X28) & young(X26) & man(X26) & fellow(X26) & young(X25) & man(X25) & fellow(X25) & ~ (X25 = X26) & front(X27) & furniture(X27) & seat(X27) & in(X22, X21) & down(X22, X23) & barrel(X22, X24) & old(X24) & dirty(X24) & white(X24) & car(X24) & chevy(X24) & lonely(X23) & way(X23) & street(X23) & event(X22) & city(X21) & hollywood(X21) & front(X20) & furniture(X20) & seat(X20)) | ~ sP0), inference(nnf_transformation, [], [f5])).
...
fof(f10, plain, ((in(sK11, sK9) & (sK8 = sK11) & in(sK10, sK2) & (sK7 = sK10) & young(sK8) & man(sK8) & fellow(sK8) & young(sK7) & man(sK7) & fellow(sK7) & ~ (sK7 = sK8) & front(sK9) & furniture(sK9) & seat(sK9) & in(sK4, sK3) & down(sK4, sK5) & barrel(sK4, sK6) & old(sK6) & dirty(sK6) & white(sK6) & car(sK6) & chevy(sK6) & lonely(sK5) & way(sK5) & street(sK5) & event(sK4) & city(sK3) & hollywood(sK3) & front(sK2) & furniture(sK2) & seat(sK2)) | ~ sP1), inference(skolemisation, [status(esa), new_symbols(skolem, [sK2, sK3, sK4, sK5, sK6, sK7, sK8, sK9, sK10, sK11])], [f8, f9])).
fof(f9, plain, (? [X0, X1, X2, X3, X4, X5, X6, X7, X8, X9] : (in(X9, X7) & (X6 = X9) & in(X8, X0) & (X5 = X8) & young(X6) & man(X6) & fellow(X6) & young(X5) & man(X5) & fellow(X5) & ~ (X5 = X6) & front(X7) & furniture(X7) & seat(X7) & in(X2, X1) & down(X2, X3) & barrel(X2, X4) & old(X4) & dirty(X4) & white(X4) & car(X4) & chevy(X4) & lonely(X3) & way(X3) & street(X3) & event(X2) & city(X1) & hollywood(X1) & front(X0) & furniture(X0) & seat(X0)) => (in(sK11, sK9) & (sK8 = sK11) & in(sK10, sK2) & (sK7 = sK10) & young(sK8) & man(sK8) & fellow(sK8) & young(sK7) & man(sK7) & fellow(sK7) & ~ (sK7 = sK8) & front(sK9) & furniture(sK9) & seat(sK9) & in(sK4, sK3) & down(sK4, sK5) & barrel(sK4, sK6) & old(sK6) & dirty(sK6) & white(sK6) & car(sK6) & chevy(sK6) & lonely(sK5) & way(sK5) & street(sK5) & event(sK4) & city(sK3) & hollywood(sK3) & front(sK2) & furniture(sK2) & seat(sK2))), introduced(choice_axiom, [])).
fof(f8, plain, (? [X0, X1, X2, X3, X4, X5, X6, X7, X8, X9] : (in(X9, X7) & (X6 = X9) & in(X8, X0) & (X5 = X8) & young(X6) & man(X6) & fellow(X6) & young(X5) & man(X5) & fellow(X5) & ~ (X5 = X6) & front(X7) & furniture(X7) & seat(X7) & in(X2, X1) & down(X2, X3) & barrel(X2, X4) & old(X4) & dirty(X4) & white(X4) & car(X4) & chevy(X4) & lonely(X3) & way(X3) & street(X3) & event(X2) & city(X1) & hollywood(X1) & front(X0) & furniture(X0) & seat(X0)) | ~ sP1), inference(nnf_transformation, [], [f6])).
...
fof(f22, plain, (street(sK5) | ~ sP1), inference(cnf_transformation, [], [f10])).
fof(f213, plain, (~ spl22_1 | spl22_25), inference(avatar_split_clause, [], [f23, f210, f91])).
fof(f23, plain, (way(sK5) | ~ sP1), inference(cnf_transformation, [], [f10])).
fof(f208, plain, (~ spl22_1 | spl22_24), inference(avatar_split_clause, [], [f24, f205, f91])).
fof(f24, plain, (lonely(sK5) | ~ sP1), inference(cnf_transformation, [], [f10])).
...
fof(f30, plain, (barrel(sK4, sK6) | ~ sP1), inference(cnf_transformation, [], [f10])).
fof(f173, plain, (~ spl22_1 | spl22_17), inference(avatar_split_clause, [], [f31, f170, f91])).
fof(f31, plain, (down(sK4, sK5) | ~ sP1), inference(cnf_transformation, [], [f10])).
